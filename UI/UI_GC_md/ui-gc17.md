...
*2.7.2.1 At final equilibrium after flooding, the righting lever curve shall have a minimum range of 20° beyond the position of equilibrium in association with a maximum residual righting lever of at least 0.1 m within the 20° range; the area under the curve within this range shall not be less than 0.0175 m-radians. The 20° range may be measured from any angle commencing between the position of equilibrium and the angle of 25° (or 30° if no deck immersion occurs). Unprotected openings shall not be immersed within this range unless the space concerned is assumed to be flooded. Within this range, the immersion of any of the openings listed in 2.7.1.1 and other openings capable of being closed weathertight may be permitted.*
