...
## GF7 (Dec 2017) External surface area of the tank for determining sizing of pressure relief valve
...
- *A = external surface area of the tank (m<sup>2</sup>), as for different tank types, as shown in figure 6.7.1.*

![Figure 6.7.1 중 원통형 탱크(구면/반구/반타원 헤드) 또는 구형 탱크와 프리즘형 탱크 형상 도해 (L excluded 및 ≤ Lmin/10 표기)](assets/ui-gf7/part01-fig-000.jpg)

![Figure 6.7.1 중 바이로브(Bilobe) 탱크 형상 도해 (excluded 영역 및 ≤ D/10 표기)](assets/ui-gf7/part01-fig-001.jpg)

![Figure 6.7.1 중 수평 원통형 탱크 배치(Horizontal cylindrical tanks arrangement) 도해 (excluded 영역 및 ≤ D/10 표기)](assets/ui-gf7/part01-fig-002.jpg)
...
1 L<sub>min</sub>, for non-tapered tanks, is the smaller of the horizontal dimensions of the flat bottom of the tank. For tapered tanks, as would be used for the forward tank, L<sub>min</sub> is the smaller of the length and the average width.

2 For prismatic tanks whose distance between the flat bottom of the tank and bottom of the hold space is equal to or less than L<sub>min</sub>/10:

A = external surface area minus flat bottom surface area.

3 For prismatic tanks whose distance between the flat bottom of the tank and bottom of the hold space is greater than L<sub>min</sub>/10:
