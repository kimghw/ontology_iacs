...
**(NO<sub>x</sub> Technical Code 2008, Chapter 1, Paragraph 1.3.2.2)**

**Paragraph 1.3.2.2, Chapter 1 of the NO<sub>x</sub> Technical Code (NTC) 2008 reads:**
...
For application of this section it shall be interpreted that an increase in "emission characteristics" relates to an increase in the application average cycle weighted NOx emission value.
