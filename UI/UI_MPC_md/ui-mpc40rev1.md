...
(NO<sub>x</sub> Technical Code 2008, Chapter 2, Paragraph 2.3.9)

Paragraph 2.3.9, Chapter 2 of the NO<sub>x</sub> Technical Code (NTC) 2008 reads:
...
The demonstration of compliance in accordance with either direct measurement and monitoring method or on-board simplified NOx measurement does not establish a new Engine Group but does define the on-board verification procedure to be used thereafter to verify continuing compliance for that particular engine.

In these instances it shall be understood that the Parent Engine emission value, as given in the EIAPP Certificate, thereafter only relates to the condition of that engine at the Precertification Survey stage.
