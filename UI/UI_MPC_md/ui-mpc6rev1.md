...
![Fig. 1 - 화물탱크 구역의 평면도 및 SECTION A-A 단면도: APT, E/R, P/R, SBT, FPT 구획과 이중선체 안쪽 SBT 위치를 보여주며, 단면에는 SBT, COT, COT, SBT 배치와 Assumed double hull line이 표시되어 있음](assets/ui-mpc6rev1/part01-fig-000.jpg)
...
![Fig. 2 - 화물탱크 구역의 평면도 및 SECTION B-B 단면도: APT, E/R, P/R, SBT, FPT 구획과 VOID SPACES 및 SBT* 위치를 보여주며, 단면에는 VOID SPACES, SBT*, COT, SBT*, VOID SPACES 배치가 표시되어 있음](assets/ui-mpc6rev1/part01-fig-001.png)
