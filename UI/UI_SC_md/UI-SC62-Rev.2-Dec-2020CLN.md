...
Interpretation of the paragraphs 2.2.3.2.7 and 2.2.3.2.8 of Chapter 15 of the IMO International Code for Fire Safety Systems (Fire Safety Systems Code) (Resolution MSC.98(73) as amended by IMO Resolutions up to MSC.410(97))

The Fire Safety Systems Code Chapter 15, 2.2.3.2.7 and 2.2.3.2.8 read as follows.
...
![Sketch 1: Arrangement with a non-return valve on the cargo piping side and two shutoff valves with a venting connection between them, isolating the inert gas main from the cargo piping](assets/UI-SC62-Rev.2-Dec-2020CLN/part01-fig-001-merged.png)

![Sketch 2: Arrangement with two shutoff valves separated by a spool piece with associated blanks, isolating the inert gas main from the cargo piping](assets/UI-SC62-Rev.2-Dec-2020CLN/part01-fig-002-merged.png)

Note:

1. Rev.2 of this Unified Interpretation is to be uniformly implemented by IACS Societies on ships contracted for construction on and after 1 January 2022.
