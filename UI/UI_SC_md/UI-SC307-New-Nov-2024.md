...
# SC307 (Nov 2024) Hydrocarbon Gas Detection and Bilge High Level Alarms in Cargo Pump-Rooms

SOLAS II-2/4.5.10 reads as follows:
...
- .1 (perpendicular) upper part of each cargo pump or between two cargo pumps;
- .2 within 30 cm above the lowest part of the cargo pump-room bottom floor;
- .3 not more than 1 m below the cargo pump room ceiling/head deck; and
- .4 one detector every 10 m length or width of the cargo pump-room.
- .5 areas where the air circulation is reduced (e.g. recessed corners).

3 A high level of liquid in the pump room should activate a continuous audible and visual alarm signal in the pump-room, cargo control room, engine control room and on the navigation bridge.

Notes:

1. This UI is to be uniformly implemented by IACS Societies on ships contracted for construction on or after 01 January 2026.
