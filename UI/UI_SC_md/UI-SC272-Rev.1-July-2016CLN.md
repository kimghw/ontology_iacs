# SC 272 (cont) Inert gas supply to double-hull spaces (SOLAS II-2/4.5.5.1)

SC 272
(Dec 2015)
(Rev.1 July 2016)

## SOLAS II-2/4.5.5.1 Application (as amended by Res.MSC.365(93))
...
## SOLAS II-2/4.5.7.3 Arrangements for fixed hydrocarbon gas detection systems in double-hull and double-bottom spaces of oil tankers
