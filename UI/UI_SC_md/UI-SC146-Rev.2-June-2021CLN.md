...
## Interpretation of SOLAS chapter II-2 regulation 10.2.3

SOLAS regulation II-2/10.2.3 reads as follows:
...
1. This UI SC146 is to be uniformly implemented by IACS Members and Associates from January 2000.
2. Rev.1 has no new implementation date.
3. Rev.2 is to be uniformly implemented by IACS Members from 1 July 2022.
