...
Any part of the fire main routed through a category A machinery space, except for short lengths of suction or discharge piping complying with SOLAS II-2/10.2.1.4.1, must be fitted with isolating valves outside of the space. The arrangements of the fire mains must allow for fire water from the fire pumps or emergency fire pump to reach all hydrants outside of the isolated space. Isolation requirements of SOLAS Reg. II-2/10.2.1.4.1 are not applicable to the piping from fire pumps located in spaces other than category A machinery spaces.

Note:

1. Rev.2 of this Unified Interpretation is to be uniformly implemented by IACS Societies on ships contracted for construction on or after 1 July 2023.
