...
\* The term "free cross-sectional area" means, even in the case of a pre-insulated duct, the area calculated on the basis of the inner diameter of the duct.

.1 subject to paragraph 7.1.1.2 the ducts are made of any material which has low flamespread characteristics;
...
.4 the ducts are not situated less than 600 mm, measured along the duct, from an opening in an "A" or "B" class division including continuous "B" class ceiling.
...
1. Rev.2 of this UI shall be uniformly implemented by IACS Societies on ships contracted for construction on or after 1 January 2015 and constructed before 1 January 2016.
