...
## SC16 (Rev.1 June 2005) (Rev.2 Aug 2006) Definitions

**(Reg. II-2/3.34)**

*Oil fuel unit* includes any equipment used for the preparation and delivery of oil fuel, heated or not, to boilers (including inert gas generators) and engines (including gas turbines) at a pressure of more than 0.18 N/mm<sup>2</sup>. Oil fuel transfer pumps are not considered as oil fuel units.
*(MSC.1/Circ.1203)*

Note:

1. Rev.1 is to be uniformly implemented by IACS Members and Associates on ships the keels of which are laid from 1 January 2006.
2. Rev.2 of this UI is editorially amended to refer to MSC.1/Circ.1203.

## SC17 (Rev.1 2001) (Rev.2 Nov 2005) Definitions - Control Stations
...
4. Spaces containing, for instance, the following battery sources should be regarded as control stations regardless of battery capacity:
