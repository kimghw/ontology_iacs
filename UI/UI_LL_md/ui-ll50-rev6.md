...
# LL50 Protection of Crew (1966 Load Line Convention Regulation 25(4), 26(2) and 27(7), 1988 Protocol Regulation 25(4), 26(2) and 27(8) and SOLAS II-1/3-3)
...
When applying Regulation 25(4), 26(2) and 27(7) of the ICLL 1966, Regulation 25(4), 26(2) and 27(8) of the Protocol 1988 as well as Regulation II-1/3-3 of SOLAS the protection of crew should be provided at least one of the means denoted in the table given below:

Type of Ship: All Ships other than Oil Tankers\*, Chemical Tankers\* and Gas Carriers\*

| Locations of access in Ship | Assigned Summer Freeboard | Type A | Type B-100 | Type B-60 | Type B&B+ |
|---|---|---|---|---|---|
| 1.1. Access to Midship Quarters<br>1.1.1. Between poop and bridge, or<br>1.1.2. Between poop and deckhouse containing living accommodation or navigating equipment, or both. | ≤ 3000 mm | a<br>b<br>e | a<br>b<br>e | a<br>b<br>c(1)<br>e<br>f(1) | a<br>b<br>c(1)<br>c(2)<br>c(4)<br>d(1)<br>d(2)<br>d(3)<br>e<br>f(1)<br>f(2)<br>f(4) |
| (same as above) | > 3000 mm | a<br>b<br>e | a<br>b<br>e | a<br>b<br>c(1)<br>c(2)<br>e<br>f(1)<br>f(2) | a<br>b<br>c(1)<br>c(2)<br>c(4)<br>d(1)<br>d(2)<br>d(3)<br>e<br>f(1)<br>f(2)<br>f(4) |
| 1.2 Access to Ends<br>1.2.1. Between poop and bow( if there is no bridge),<br>1.2.2. Between bridge and bow, or<br>1.2.3. Between a deckhouse containing living accommodation or navigating equipment, or both, and bow, or<br>1.2.4. In the case of a flush deck vessel, between crew accommodation and the forward and after ends of ship. | ≤ 3000 mm | a<br>b<br>c(1)<br>e<br>f(1) | a<br>b<br>c(1)<br>c(2)<br>e<br>f(1)<br>f(2) | a<br>b<br>c(1)<br>c(2)<br>e<br>f(1)<br>f(2) | a<br>b<br>c(1)<br>c(2)<br>c(4)<br>d(1)<br>d(2)<br>d(3)<br>e<br>f(1)<br>f(2)<br>f(4) |
| (same as above) | > 3000 mm | a<br>b<br>c(1)<br>d(1)<br>e<br>f(1) | a<br>b<br>c(1)<br>c(2)<br>d(1)<br>d(2)<br>e<br>f(1)<br>f(2) | a<br>b<br>c(1)<br>c(2)<br>c(4)<br>d(1)<br>d(2)<br>d(3)<br>e<br>f(1)<br>f(2)<br>f(4) | a<br>b<br>c(1)<br>c(2)<br>c(4)<br>d(1)<br>d(2)<br>d(3)<br>e<br>f(1)<br>f(2)<br>f(4) |

Note on the "All Ships" table: In the original, the Type B&B+ column for row 1.1 ("Access to Midship Quarters") spans both the "≤ 3000 mm" and "> 3000 mm" sub-rows with a single merged cell containing `a, b, c(1), c(2), c(4), d(1), d(2), d(3), e, f(1), f(2), f(4)`. Likewise, the Type B-60 column for row 1.2 ("Access to Ends") with freeboard "> 3000 mm" and the Type B&B+ column for both freeboard sub-rows of 1.2 span vertically with a single merged cell containing `a, b, c(1), c(2), c(4), d(1), d(2), d(3), e, f(1), f(2), f(4)`. These merged cells are repeated in the markdown rendering above to preserve all information.

Type of Ship: Oil Tankers\*, Chemical Tankers\* and Gas Carriers\*

| Locations of access in Ship | Assigned Summer Freeboard | Acceptable arrangements |
|---|---|---|
| 2.1 Access to Bow<br>2.1.1. Between poop and bow, or<br>2.1.2. Between a deckhouse containing living accommodation or navigating equipment, or both, and bow, or<br>2.1.3. In the case of a flush deck vessel, between crew accommodation and the forward ends of ship. | ≤ (A<sub>f</sub> + H<sub>s</sub>)\*\* | a<br>e<br>f(1)<br>f(5) |
| (same as above) | > (A<sub>f</sub> + H<sub>s</sub>)\*\* | a<br>e<br>f(1)<br>f(2) |
| 2.2 Access to After End<br>In the case of a flush deck vessel, between crew accommodation and the after end of ship | (not specified) | as required in 1.2.4 for other types of ships |
...
2. This UI is applicable to Regulations 25(4), 26(2) and 27(7) of the 1966 ICLL and Regulations 25(4), 26(2) and 27(8) of the 1988 Protocol.

\* Oil Tankers, Chemical Tanker and Gas Carrier as defined in SOLAS II-1/2.12, VII/8.2 and VII/11.2 respectively, of the International Convention for the Safety of Life at Sea, 1974, as amended.

\*\* A<sub>f</sub>: the minimum summer freeboard calculated as type A ship regardless of the type freeboard actually assigned.

H<sub>s</sub>: the standard height of superstructure as defined in ICLL Regulation 33.
...
1. In all cases where wire ropes are fitted, adequate devices (for example turnbuckles) are to be provided to ensure their tautness.
