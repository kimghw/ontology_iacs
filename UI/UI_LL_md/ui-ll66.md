...
(Res. MSC.143(77), 2005 LL Protocol Regulation 16(5) (a) & (b))
...
In the calculation of stress and deflection from the prescribed mass per unit area, the design pressure is to be determined by using a vertical acceleration equal to 1.0g.

Note: This UI LL 66 is to be uniformly implemented by IACS Members and Associates from 1 January 2005.
