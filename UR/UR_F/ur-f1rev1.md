...
### F1.3 Aluminium anodes are only permitted in cargo tanks and tanks adjacent to cargo tanks in locations where the potential energy does not exceed 28 kg m (200 ft lb).
...
### F1.6 The steel inserts are to be attached to the structure by means of a continuous weld of adequate section.

Alternatively they may be attached to separate supports by bolting, provided a minimum of two bolts with locknuts are used. However, approved mechanical means of clamping will be accepted.
