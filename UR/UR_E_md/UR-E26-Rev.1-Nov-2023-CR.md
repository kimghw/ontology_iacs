...
Fallback to a minimal risk condition usually implies the capability of a system to abort the current operation and signal the need for assistance, and may be different depending on environmental conditions, the voyage phase of the ship (e.g. port depart/arrival vs. open sea passage) and the events occurred.
...
Upon delivery of the ship, the systems integrator shall provide documentation to the shipowner:
...
| Ship cyber security and resilience program [5.3.1] | | | | | Maintain | Submit | Demonstrate |
...
|  |
| --- | --- | --- |
| *CBS security capabilities* | Human user id. and auth. (#1) | E27 (4.1) |
| | Account management (#2) | |
| | Identifier management (#3) | |
| | Authenticator management (#4) | |
| | Authorisation enforcement (#8) | |
| *CBS documentation* | Description of security capabilities | E27 (3.1.3) |
| | Test procedure for security capabilities | E27 (3.1.4) |
...
|  |
| --- | --- | --- |
| *CBS security capabilities* | Wireless access management (#5) | E27 (4.1) |
| | Wireless use control (#9) | |
| *CBS documentation* | Description of security capabilities | E27 (3.1.3) |
| | Test procedure for security capabilities | E27 (3.1.4) |
...
|  |
| --- | --- | --- |
| *CBS security capabilities* | Multifactor authentication (#31) | E27 (4.2) |
| | Process / device id. and auth. (#32) | |
| | Unsuccessful login attempts (#33) | |
| | System use notification (#34) | |
| | Access via untrusted networks (#35) | |
| | Explicit access request approval (#36) | |
| | Remote session termination (#37) | |
| | Cryptographic integrity protection (#38) | |
| | Input validation (#39) | |
| | Session integrity (#40) | |
| | Invalidation of session ID (#41) | |
| *CBS documentation* | Description of security capabilities | E27 (3.1.3) |
| | Test procedure for security capabilities | E27 (3.1.4) |
...
|  |
| --- | --- | --- |
| *CBS security capabilities* | System backup (#26) | E27 (4.1) |
| | System recovery and reconstitution (#27) | |
| *CBS documentation* | Description of security capabilities | E27 (3.1.3) |
| | Test procedure for security capabilities | E27 (3.1.4) |
| | Information supporting incident response and recovery plans | E27 (3.1.8) |
