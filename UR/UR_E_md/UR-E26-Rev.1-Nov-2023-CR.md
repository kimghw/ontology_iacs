...
The systems integrator shall submit Zones and conduit diagram and the Cyber security design description (see sections 5.1.1 and 5.1.2).
...
- Any CBSs in the scope of applicability of this UR that do not meet the requirements in UR E27 section 4.1 item 10, i.e., that shall have protection of interface ports by physical means such as port blockers.
