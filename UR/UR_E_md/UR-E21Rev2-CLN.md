...
![Double Conversion topology diagram showing AC input to Rectifier to DC link to Inverter to AC output, with Energy storage device connected at DC link](assets/UR-E21Rev2-CLN/part01-fig-000.png)
...
![Line interactive topology diagram showing AC input to Power interface to AC output, with Bidirectional converter and Energy storage device](assets/UR-E21Rev2-CLN/part01-fig-001.png)
...
![Standby topology diagram showing AC input to Battery charger to Inverter to UPS switch to AC output, with Energy storage device](assets/UR-E21Rev2-CLN/part01-fig-002.png)
