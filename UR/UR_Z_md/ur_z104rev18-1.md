...
2. Reporting forms TM1-DHT, TM2-DHT, TM3-DHT, TM4-DHT, TM5-DHT and TM6-DHT (sheets 4-10) are to be used for recording thickness measurements and the maximum allowable diminution is to be stated.
...
#### TM1-DHT Report on THICKNESS MEASUREMENT of ALL DECK PLATING, ALL BOTTOM SHELL PLATING or SIDE SHELL PLATING\* (Sheet 4)
...
#### TM2-DHT (i) Report on THICKNESS MEASUREMENT OF SHELL AND DECK PLATING (one, two or three transverse sections) (Sheet 5)
...
#### TM2-DHT (ii) Report on THICKNESS MEASUREMENT OF SHELL AND DECK PLATING (one, two or three transverse sections) (Sheet 6)
...
#### TM3-DHT Report on THICKNESS MEASUREMENT OF LONGITUDINAL MEMBERS (one, two or three transverse sections) (Sheet 7)
...
#### TM4-DHT Report on THICKNESS MEASUREMENT OF TRANSVERSE STRUCTURAL MEMBERS In the cargo oil and water ballast tanks within the cargo tank length (Sheet 8)
...
#### TM5-DHT Report on THICKNESS OF W.T./O.T. TRANSVERSE BULKHEADS within the cargo tank or cargo hold spaces (Sheet 9)
...
#### TM6-DHT Report on THICKNESS MEASUREMENT OF MISCELLANEOUS STRUCTURAL MEMBERS (Sheet 10)
...
#### Thickness Measurement - Double Hull Oil Tankers (Sheet 11)

Typical transverse section of a double hull oil tanker up to 150,000 dwt with indication of longitudinal and transverse members

![Sheet 11: Typical transverse section of a double hull oil tanker up to 150,000 dwt showing numbered structural items including topside tank, multiple deck girders, centreline bulkhead, and numbered items 1-36 distributed across the section for thickness measurement.](assets/ur_z104rev18-1/part02-fig-001.png)
...
#### Thickness Measurement - Double Hull Oil Tankers (Sheet 12)

Typical transverse section of a double hull oil tanker above 150,000 dwt with indication of longitudinal and transverse members

![Sheet 12: Typical transverse section of a double hull oil tanker above 150,000 dwt with Cross Tie in Centre Tank, showing numbered structural items 1-36 distributed across the section for thickness measurement reporting.](assets/ur_z104rev18-1/part02-fig-003.jpg)

| Report on TM2-DHT (i) & (ii) |
|---|
| 0. Strength deck plating |
| 1. Stringer plate |
| 2. Sheerstrake |
...
| Report on TM3-DHT |  |
|---|---|
| 10. Deck longitudinals | 20. Longitudinal bulkhead plating (remainder) |
| 11. Sheerstrake longitudinals | 21. Longitudinal bulkhead longitudinals |
| 12. Side shell longitudinals | 22. Inner side plating |
| 13. Bilge longitudinals | 23. Inner side longitudinals |
| 14. Bottom longitudinals | 24. Hopper plating |
| 15. Deck girders | 25. Hopper longitudinals |
| 16. Horizontal girders in wing ballast tanks | 26. Inner bottom plating |
...
#### Thickness Measurement - Double Hull Oil Tankers (Sheet 13)

Transverse section outline

The diagram may be used for those ships where the diagrams on sheet 11 and 12 are not suitable

![Sheet 13: Transverse section outline — a simplified hull outline to be used for those ships where the diagrams on sheets 11 and 12 are not suitable.](assets/ur_z104rev18-1/part02-fig-004.png)
...
Areas subject to close-up survey and thickness measurements - areas (1) to (5) as defined in Table I of UR Z10.4 - Thickness to be reported on TM3-DHT(CSR), TM4-DHT(CSR) and TM5-DHT(CSR) as appropriate.

![Sheet 14: Transverse section and transverse bulkheads of a double hull oil tanker showing typical close-up survey and thickness measurement areas (1) to (5) with dashed boxes indicating close-up survey area locations.](assets/ur_z104rev18-1/part02-fig-006.jpg)

#### Close-up Survey and Thickness Measurement Areas (Sheet 15)

Areas subject to close-up survey and thickness measurements - areas (6) to (7) as defined in Table I of UR Z10.4 - Thickness to be reported on TM3-DHT(CSR), TM4-DHT(CSR) as appropriate.

![Sheet 15: Transverse section of a double hull oil tanker showing typical close-up survey and thickness measurement areas (6) to (7) with dashed boxes indicating close-up survey area locations.](assets/ur_z104rev18-1/part02-fig-007.jpg)
...
- Sheet 11 - Typical transverse section of a double hull oil tanker (up to 150,000 dwt). The diagram includes details of the items to be measured and the report forms to be used.
- Sheet 12 - Typical transverse section of a double hull oil tanker (above 150,000 dwt). The diagram includes details of the items to be measured and the report forms to be used.
- Sheet 13 - Transverse section outline. This diagram may be used for those ships where the diagram on sheet 11 and sheet 12 is not suitable.
- Sheet 14 - Transverse section and transverse bulkheads of a double hull oil tanker showing typical areas for thickness measurement in association with close-up survey requirements, areas (1) to (5) as defined in Table I of the UR Z10.4.
- Sheet 15 - Transverse section of a double hull oil tanker showing typical areas for thickness measurement in association with close-up survey requirements, areas (6) to (7) as defined in Table I of the UR Z10.4.
...
#### TM1-DHT(CSR) Report on THICKNESS MEASUREMENT of ALL DECK PLATING, ALL BOTTOM PLATING or SIDE SHELL PLATING\* (Sheet 4)
...
#### TM2-DHT(CSR) (i) Report on THICKNESS MEASUREMENT OF SHELL AND DECK PLATING (one, two or three transverse sections) (Sheet 5)
...
#### TM2-DHT(CSR) (ii) Report on THICKNESS MEASUREMENT OF SHELL PLATING (one, two or three transverse sections) (Sheet 6)
...
#### TM3-DHT(CSR) Report on THICKNESS MEASUREMENT OF LONGITUDINAL MEMBERS (one, two or three transverse sections) (Sheet 7)
...
### TM5-DHT(CSR) — Report on THICKNESS OF W.T./O.T. TRANSVERSE BULKHEADS
...
3. The remaining corrosion addition is to be recorded with result of gauged thickness minus renewal thickness. If the result is negative, the structure in way shall be renewed, and the mark "R" is to be indicated in the right-hand column. If the result is between 0 and 0.5 mm (0 included), the structure in way shall be additional gauged, and the mark "S" is to be indicated in the right-hand column.

### Thickness Measurement - Double Hull Oil Tankers (Sheet 11)

Typical transverse section of a double hull oil tanker up to 150,000 dwt with indication of longitudinal and transverse members

![Typical transverse section of a double hull oil tanker up to 150,000 dwt showing topside tank, multiple deck girders, centreline bulkhead, and numbered structural members (1–29, 33)](assets/ur_z104rev18-1/part03-fig-000.jpg)

| Report on TM2-DHT(CSR) (i) & (ii) |
| --- |
| 0. Strength deck plating |
| 1. Stringer plate |
| 2. Sheerstrake |
...
| 11. Sheerstrake longitudinals | 21. Longitudinal bulkhead longitudinals |
| 12. Side shell longitudinals | 22. Inner side plating |
| 13. Bilge longitudinals | 23. Inner side longitudinal |
| 14. Bottom longitudinals | 24. Hopper plating |
| 15. Deck girders | 25. Hopper longitudinal |
| 16. Horizontal girders in wing ballast tanks | 26. Inner bottom plating |
| 17. Bottom girders | 27. Inner bottom longitudinals |
| 18. Longitudinal bulkhead top strake | 28. Topside tank plating |
| 19. Longitudinal bulkhead bottom strake | 29. Topside tank longitudinals |

| Report on TM4-DHT(CSR) |
| --- |
| 30. Deck transverse - centre tank |
| 31. Deck transverse - wing tank |
| 32. Vertical web in wing ballast tank |
...
![Typical transverse section of a double hull oil tanker above 150,000 dwt showing cross tie in centre tank and numbered structural members (1–34)](assets/ur_z104rev18-1/part03-fig-001.jpg)
...
![Blank transverse section outline of a double hull oil tanker showing only the bare hull curve for recording](assets/ur_z104rev18-1/part03-fig-002.jpg)
...
![Two transverse section diagrams marking close-up survey areas (1) to (5) within a double hull oil tanker](assets/ur_z104rev18-1/part03-fig-003.jpg)

### Close-up Survey and Thickness Measurement Areas (Sheet 15)

Areas subject to close-up survey and thickness measurements - areas (6) to (7) as defined in Table I of UR Z10.4 - Thickness to be reported on TM3-DHT(CSR), TM4-DHT(CSR) as appropriate.

![Transverse section diagram marking close-up survey areas (6) and (7) within a double hull oil tanker](assets/ur_z104rev18-1/part03-fig-004.jpg)
...
$$Z_{mc} = cL^2B\,(C_b + 0.7)k\quad (\text{cm}^3)$$
...
$$c_n = 10.75 - \left(\frac{300 - L}{100}\right)^{1.5}\quad \text{for } 130\,\text{m} \le L \le 300\,\text{m}$$

$$c_n = 10.75\quad \text{for } 300\,\text{m} < L < 350\,\text{m}$$

$$c_n = 10.75 - \left(\frac{L - 350}{150}\right)^{1.5}\quad \text{for } 350\,\text{m} \le L \le 500\,\text{m}$$
...
The following information will enable the owner in co-operation with the Classification Society to develop a survey programme complying with the requirements of UR Z10.4. It is essential that the owner provides, when completing the present questionnaire, up-to-date information. The present questionnaire, when completed, is to provide all information and material required by UR Z10.4.
...
| Tank No. | Structure | C(Cargo)/B(Ballast) | Permanent Means of Access | Temporary staging | Rafts | Ladders | Direct access | Other means (please specify) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| F.P. | Fore Peak |  |  |  |  |  |  |  |
| A.P. | Aft Peak |  |  |  |  |  |  |  |
| Wing Tanks | Under deck |  |  |  |  |  |  |  |
| Wing Tanks | Side shell |  |  |  |  |  |  |  |
| Wing Tanks | Bottom transverse |  |  |  |  |  |  |  |
| Wing Tanks | Longitudinal |  |  |  |  |  |  |  |
| Wing Tanks | Transverse |  |  |  |  |  |  |  |
| Centre Tanks | Underdeck |  |  |  |  |  |  |  |
| Centre Tanks | Bottom transverse |  |  |  |  |  |  |  |
| Centre Tanks | Transverse |  |  |  |  |  |  |  |
