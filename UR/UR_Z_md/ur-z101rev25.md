...
<!-- markdownlint-disable MD007 MD032 MD024 MD056 MD046 MD036 MD037 MD026 -->
...
8. Changes introduced in Rev.13 (para. 1.4, 5.5.6, 5.5.6 and 7.1.3) are to be uniformly applied by IACS Societies on surveys commenced on or after 1 January 2007.
...
1.2.13 **Special consideration** or **specially considered** (in connection with close-up surveys and thickness measurements) means sufficient close-up inspection and thickness measurements are to be taken to confirm the actual average condition of the structure under the coating.
...
2.4.4 For areas in tanks where hard protective coating is found to be in a GOOD condition as defined in 1.2.11, the extent of thickness measurements according to Table II may be specially considered.
...
![Figure 1 Maximum water level in a tank — cross-section diagram showing 3.0 m ullage clearance from deck at midspan of deck transverses and middle length of tank, illustrating requirements for rafting of under deck structure](assets/ur-z101rev25/part01-fig-000.png)
...
| D) ONE TRANVERSE BULKHEAD - in a ballast tank | B) ONE DECK TRANSVERSE - in a cargo wing tank | A) A minimum of 30% of all web frame rings in each remaining cargo wing tank (see Note 1) | |
...
| 2. One section of deck plating for the full beam of the ship within the cargo area (in way of a ballast tank, if any, or a cargo tank used primarily for water ballast) | 2. Within the cargo area:<br>.1 Each deck plate<br>.2 One transverse section | 2. Within the cargo area:<br>.1 Each deck plate<br>.2 Two transverse sections <sup>(1)</sup><br>.3 All wind and water strakes | 2. Within the cargo area:<br>.1 Each deck plate<br>.2 Three transverse sections <sup>(1)</sup><br>.3 Each bottom plate |
...
| Special Survey No.1<br>age ≤ 5 | Special Survey No.2 and Subsequent<br>age > 5 |
|---|---|
...
|---|---|---|
| 1. Bottom plating | Minimum of 3 bays across tank aft bay<br>Measurements around and under all bell mouths | 5 point pattern for each panel between longitudinals and webs |
...
g) Measurement record format in accordance with the Recommended Procedures for Thickness Measurements of Oil Tankers, Ore/Oil Ships and etc., contained in Annex II.
...
| 1)<br>Positions of substantially corroded Tanks/Areas or Areas with deep pitting | Thickness diminution [%] | 2)<br>Corrosion pattern | Remarks:<br>e.g. Ref. attached sketches |
|---|---|---|---|
| | | | |
...
| 1)<br>Tank Nos. | 2)<br>Tank protection | 3)<br>Coating condition | Remarks |
|---|---|---|---|
| | | | |
...
|---|---|---|---|---|
| | | Z<sub>act</sub> (cm<sup>3</sup>) <sup>*1</sup> | Z<sub>mc</sub> (cm<sup>3</sup>) <sup>*2</sup> | Remarks |
| Transverse Section 1 | Upper deck | | | |
| | Bottom | | | |
| Transverse Section 2 | Upper deck | | | |
| | Bottom | | | |
...
Technical assessments performed in conjunction with the survey planning process are, in principle to be as shown schematically in Figure 1 depicts, how technical assessments can be carried out in conjunction with the survey planning process.
...
The nomination of tanks and spaces for close-up survey should, initially, be based on highest corrosion risk, and should always include ballast tanks. For close-up survey should, initially, be based on highest corrosion risk, and should always include ballast tanks. The principle for the selection is to be that the extent is increased by age or where information is insufficient or unreliable.

*Figure 1: Technical Assessment and the Survey Planning Process — flowchart showing inputs (drawings, reports, acceptable corrosion allowance, coating condition, usage of tanks) feeding into two parallel branches (Design Related Risk: analyse hull damage this ship → similar ships → general experience → present areas where damage has been found and risks considered high; Corrosion Risk: coating condition / usage of tanks → corrosion damage this ship → similar ships), both converging to "Location for Thickness Measurement and Close-Up Survey" → Survey Programme → Acceptance by Class & Owner → Survey.*

![Figure 2 Typical Damage and Repair Example (Reproduced from Ref. 1) — TSCF catalogue of structural details showing web and flat bar fractures at cut-outs for longitudinal stiffener connections; left side depicts typical damage with fractures in web plating, longitudinal bulkhead, and flat bar stiffener; right side depicts proposed repair using full collar lug if fractures in web plate are small and repaired by welding, with backing bracket and web and flat bar cropped and part renewed or alternatively welded; view A-A shows side shell or bulkhead longitudinal, web plating, fracture, web flat bar stiffener; factors contributing to damage listed: asymmetrical connection of flat bar stiffener, insufficient area of connection of longitudinal to web plate, defective weld at return around plate thickness, high localised corrosion at stress concentration areas, high stress in web of transverse, dynamic sea way load/ship motions](assets/ur-z101rev25/part01-fig-001.png)
...
**Report on THICKNESS MEASUREMENT OF TRANSVERSE STRUCTURAL MEMBERS** In the cargo oil and water ballast tanks within the cargo tank length
...
**Report on THICKNESS OF W.T./O.T. TRANSVERSE BULKHEADS** within the cargo tank or cargo hold spaces
...
![Oil tanker typical transverse section diagram indicating longitudinal and transverse members numbered 1 through 33 for thickness measurement reporting](assets/ur-z101rev25/part02-fig-000.png)
...
![Ore/Oil ship typical transverse section diagram indicating longitudinal and transverse members numbered 1 through 33 for thickness measurement reporting](assets/ur-z101rev25/part02-fig-001.png)
...
![Blank transverse section outline to be used for longitudinal and transverse members where the typical Oil Tanker or Oil/Ore ship sections on sheets 11 and 12 are not applicable](assets/ur-z101rev25/part02-fig-002.png)
...
![Typical transverse section diagrams of an Oil Tanker and an Ore/oil Ship showing all longitudinal members to be reported on TM2-T and TM3-T](assets/ur-z101rev25/part02-fig-003.png)
...
![Close-up survey requirement diagrams: Oil Tanker typical transverse section close-up survey and typical transverse bulkhead (thickness reported on TM3-T, TM4-T and TM5-T), plus Oil/Ore ship typical transverse section close-up survey and typical transverse bulkhead, with close-up survey area indicated by dashed boxes](assets/ur-z101rev25/part02-fig-004.png)

Oil Tanker
Typical transverse section close-up survey

Thickness to be reported on TM3-T and TM4-T as appropriate

Oil Tanker
Typical transverse bulkhead

Thickness to be reported on TM5-T
...
4 A deduction-free sum of smaller opening breadths in one transverse section in the bottom or deck area of 0.06(B - ∑b) (where B = breadth of ship, ∑b = total breadth of large openings) may be considered equivalent to the above reduction in sectional modulus.
...
&nbsp;&nbsp;&nbsp;&nbsp;x and y to be measured to the point giving the largest value of y<sub>t</sub>.
...
1 The diminution limit of the minimum section modulus (Z<sub>mc</sub>) of oil tankers in service is given by the following formula:

$$Z_{mc} = cL^2 B\,(C_b + 0.7)k \quad \text{(cm}^3\text{)}$$
...
&nbsp;&nbsp;&nbsp;&nbsp;C<sub>b</sub> =   Moulded block coefficient at draught *d* corresponding to summer load waterline, based on L and B. C<sub>b</sub> is not to be taken less than 0.60.

$$C_b = \frac{\text{moulded displacement (m}^3\text{) at draught } d}{L \times B \times d}$$

&nbsp;&nbsp;&nbsp;&nbsp;c    =   0.9 c<sub>n</sub>

$$c_n = 10.75 - \left(\frac{300 - L}{100}\right)^{1.5} \quad \text{for } 130\text{ m} \leq L \leq 300\text{ m}$$

$$c_n = 10.75 \quad \text{for } 300\text{ m} < L < 350\text{ m}$$

$$c_n = 10.75 - \left(\frac{L - 350}{150}\right)^{1.5} \quad \text{for } 350\text{ m} \leq L \leq 500\text{ m}$$

&nbsp;&nbsp;&nbsp;&nbsp;k =    material factor, e.g.

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;k = 1.0 for mild steel with yield stress of 235N/mm<sup>2</sup> and over;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;k = 0.78 for high tensile steel with yield stress of 315N/mm<sup>2</sup> and over;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;k = 0.72 for high tensile steel with yield stress of 355N/mm<sup>2</sup> and over.
