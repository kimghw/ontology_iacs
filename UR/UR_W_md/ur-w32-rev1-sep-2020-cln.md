...
3.2 Base metals for qualification of welders or welding operators are combined into one group with a specified minimum yield strength R<sub>eH</sub>≤460 N/mm<sup>2</sup>. The welding of any one metal in this group covers qualification of the welder or welding operator for the welding of all other metals within this group.
...
| | | Metal active gas (MAG) welding<br>Flux cored arc (FCA) welding | 135, 138<sup>1</sup><br>136<sup>2</sup> |
...
<sup>1</sup> A change from MAG welding with solid wires (135) to that with metal cored wires (138), or vice versa is permitted.

<sup>2</sup> A change from a solid or metal cored wire (135/138) to a flux cored wire (136) or vice versa requires a new welder qualification test.
...
![a) PA: flat position - butt weld and fillet weld diagrams showing weld position p](assets/ur-w32-rev1-sep-2020-cln/part01-fig-000.png)

a) PA: flat position

![b) PB: horizontal vertical position - fillet weld diagram showing weld position p](assets/ur-w32-rev1-sep-2020-cln/part01-fig-001.png)

b) PB: horizontal vertical position

![c) PC: horizontal position - butt weld and fillet weld diagrams showing weld position p](assets/ur-w32-rev1-sep-2020-cln/part01-fig-002.png)

c) PC: horizontal position

![d) PD: horizontal overhead position - fillet weld diagram showing weld position p](assets/ur-w32-rev1-sep-2020-cln/part01-fig-003.png)

d) PD: horizontal overhead position

![e) PE: overhead position - butt weld and fillet weld diagrams showing weld position p](assets/ur-w32-rev1-sep-2020-cln/part01-fig-004.png)

e) PE: overhead position

![f) PF: vertical up position - butt weld diagrams showing upward weld position p](assets/ur-w32-rev1-sep-2020-cln/part01-fig-005.png)

f) PF: vertical up position

![g) PG: vertical down position - butt weld diagrams showing downward weld position p](assets/ur-w32-rev1-sep-2020-cln/part01-fig-006.png)

g) PG: vertical down position

Note: p is the welding position.

Figure 1 Welding positions
...
![Figure 2 test assembly for butt welds with T less than 12mm showing face bend, root bend specimens and discard regions, minimum 200mm dimensions](assets/ur-w32-rev1-sep-2020-cln/part01-fig-007.png)

Figure 2 Dimensions and types of test assembly for butt welds (T < 12mm)

![Figure 3 test assembly for butt welds with T greater than or equal to 12mm showing four side bend test specimens and discard regions, minimum 200mm dimensions](assets/ur-w32-rev1-sep-2020-cln/part01-fig-008.png)

Figure 3 Dimensions and types of test assembly for butt welds (T ≥ 12mm)

![Figure 4 test assembly for fillet welds showing T-joint with fracture test specimen, Min. 150/100/200 dimensions and throat thickness formula Z=a√2 with condition For T ≥ 6mm 0.5T ≤ a ≤ 0.5T + 3mm and For T < 6mm 0.5T ≤ a ≤ T](assets/ur-w32-rev1-sep-2020-cln/part01-fig-009.png)

Figure 4 Dimensions and types of test assembly for fillet welds

![Figure 5 test assembly for tack butt welds showing About 200 plate with three tack welds spaced About 20/30 with About 100 total, cross-section with 60 degree bevel and 3-6 gap and About 10 thickness](assets/ur-w32-rev1-sep-2020-cln/part01-fig-010.png)

Figure 5 Dimensions and types of test assembly for tack butt welds

![Figure 6 test assembly for tack fillet welds showing T-joint with three tack welds About 20/30 spacing along About 100 length on About 100x200 plates](assets/ur-w32-rev1-sep-2020-cln/part01-fig-011.png)

Figure 6 Dimensions and types of test assembly for tack fillet welds
...
- Hull structural steels with specified minimum yield point 460 N/mm<sup>2</sup> specified in UR W31
...
| Welder's name: | | Date of birth: | | |
|---|---|---|---|---|
| Cert. No: | | Sex: | | Photograph |
| Identification No. | | | | |
...
| Welding position | | |
| Revalidation method | In accordance with 6.2.1 a) ☐    b) ☐    c) ☐ | |
| Other details | | |

This certificate is issued at _________ [place], and valid until __________ [DD/MM/YYYY].

Signature/seal of examiner: _________  Issued on ____________________ [DD/MM/YYYY].
