...
Note: This UR is to be uniformly implemented by IACS Societies in respect of anchors, the manufacturing of which is commenced on or after 1 January 2007.

## 2. Materials

### 2.1 Materials for anchors

All anchors are to be manufactured from materials meeting the requirements of the UR Ws as indicted below:
...
![Figure 1 Allowable lateral movement of shank](assets/ur-w29/part01-fig-000.png)
...
| Programme B | Applicable <sup>(1)</sup> | Applicable | Applicable |
