...
Test assemblies are to be examined by visual and by non-destructive testing prior to the cutting of test specimen. In case that any post-weld heat treatment is required or specified, non-destructive testing is to be performed after heat treatment. For steels according to UR W16 with specified minimum yield strength of 420 N/mm<sup>2</sup> and above the non-destructive testing is to be delayed for a minimum of 48 hrs, unless heat treatment has been carried out. NDT procedures are to be agreed with the Society.
...
| A<sup>(3)</sup> | 20 | 47 | 34 | 34 |
| B<sup>(3)</sup>, D | 0 | 47 | 34 | 34 |
| E | -20 | 47 | 34 | 34 |
| A32, A36 | 20 | 47 | 34 | 34 |
| D32, D36 | 0 | 47 | 34 | 34 |
| E32, E36 | -20 | 47 | 34 | 34 |
...
Hardness test is required for steels with specified minimum yield strength of R<sub>eH</sub> ≥ 355 N/mm<sup>2</sup>. The Vickers method HV 10 is normally to be used. The indentations are to be made in the weld metal, the heat affected zone and the base metal measuring and recording the hardness values. At least two rows of indentations are to be carried out in accordance with Fig. 1 and 2 of Annex B.
...
- Steel with a specified minimum yield strength R<sub>eH</sub> ≤ 420 N/mm<sup>2</sup>                ; 350 HV10

- Steel with a specified minimum yield strength 420 N/mm<sup>2</sup> < R<sub>eH</sub> ≤ 690 N/mm<sup>2</sup>        ; 420 HV10
...
Hardness test is required for steels with a specified minimum yield strength of R<sub>eH</sub> ≥ 355 N/mm<sup>2</sup>. The Vickers method HV 10 is normally to be used. The indentations are to be made in the weld metal, the heat affected zone and the base metal measuring and recording the hardness values. At least two rows of indentations are to be carried out in accordance with Fig. 3, 4a and 4b of Annex B.
...
5.3.5 Notwithstanding the above, the approval of maximum thickness of base metal for any technique is to be restricted to the thickness of test assembly if three of the hardness values in the heat affected zone are found to be within 25 HV of the maximum permitted, as stated in 4.2.2.7 and 4.3.3.3.
...
![Annex B Fig.1 Examples of hardness test with rows of indentations (R) in butt welds showing three butt weld cross-sections with 2mm max distance indentation rows](assets/ur-w28rev2/part01-fig-003.png)
...
![Annex B Fig.2 Example showing the position of indentations for hardness test in a butt weld cross-section covering weld metal, HAZ, and base metal](assets/ur-w28rev2/part01-fig-004.png)
...
![Annex B Fig.3 Examples of hardness test with row indentation (R) for (a) fillet weld and (b) T-joint weld showing 2mm max distances](assets/ur-w28rev2/part01-fig-005.png)

a) Fillet weld        b) T-joint weld

Fig. 3    Examples of hardness test with row indentation (R) in fillet welds and in T-joint welds

![Annex B Fig.4a Example of indentation positions in a fillet weld cross-section showing rows of indentations through weld metal, HAZ, and base metal with dimensions h≤2 and h≤0.5](assets/ur-w28rev2/part01-fig-006.png)
...
![Annex B Fig.4b Example of indentation positions in a T-joint weld cross-section showing rows of indentations through weld metal, HAZ, and base metal with dimensions h≤2 and h≤0.5](assets/ur-w28rev2/part01-fig-007.png)
...
![Annex C.1 Welding positions according to ISO Standard showing PA Flat, PC Horizontal Vertical, PG Vertical downwards, PF Vertical upwards, PO Overhand for both butt welds and fillet welds for plates](assets/ur-w28rev2/part01-fig-008.png)
...
![Annex C.2 a) AWS-Code butt weld test positions 1G (plates horizontal), 2G (plates vertical axis of weld horizontal), 3G (plates vertical axis of weld vertical), 4G (plates horizontal overhead)](assets/ur-w28rev2/part01-fig-009.png)

Annex C.2: Welding positions according to AWS-Code

a) Butt weld for plates

(A) TEST POSITION 1G — PLATES HORIZONTAL
(B) TEST POSITION 2G — PLATES VERTICAL: AXIS OF WELD HORIZONTAL
(C) TEST POSITION 3G — PLATES VERTICAL: AXIS OF WELD VERTICAL
(D) TEST POSITION 4G — PLATES HORIZONTAL

![Annex C.2 b) AWS-Code fillet weld test positions 1F flat, 2F horizontal, 3F vertical, 4F overhead showing throat and axis of weld orientations](assets/ur-w28rev2/part01-fig-010.png)

b) Fillet welds for plates

(A) FLAT POSITION 1F — THROAT OF WELD VERTICAL, AXIS OF WELD HORIZONTAL
(B) HORIZONTAL POSITION 2F — AXIS OF WELD HORIZONTAL (Note: One plate must be horizontal)
(C) VERTICAL POSITION 3F — AXIS OF WELD VERTICAL
(D) OVERHEAD POSITION 4F — AXIS OF WELD HORIZONTAL (Note: One plate must be horizontal)
