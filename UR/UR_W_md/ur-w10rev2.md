...
W10.5.2 For some applications, such as high temperature service or where dimensional stability is important, it may be required that castings be given a suitable tempering or stress relieving heat treatment. This is to be carried out after any refining heat treatment and before machining. The special qualities with 350 N/mm<sup>2</sup> and 400 N/mm<sup>2</sup> nominal tensile strength and impact test shall undergo a ferritizing heat treatment.
...
![Fig. 1 Type A test samples (U-type) - tapered U-shaped test sample attached to a rectangular block, with dimensions u, v, x, y, z and fillet radius Rs marked, and a 3° taper noted on the neck](assets/ur-w10rev2/part01-fig-001.png)
...
![Fig. 2 Type B test samples (double U-type) - a test sample with three u-wide projections forming a double U-notch, attached to a rectangular block, with dimensions v, x, y, z, Rs and a 3° taper marked](assets/ur-w10rev2/part01-fig-002.png)
...
![Fig. 3 Type C test samples (Y-type) - a Y-shaped tapered test sample with a small square base attached to a rectangular block, with dimensions u, v, x, y, z marked](assets/ur-w10rev2/part01-fig-003.png)

Fig. 3 Type C test samples (Y-type)
...
| Category | Specified minimum tensile strength (N/mm<sup>2</sup>) | 0,2% proof stress (N/mm<sup>2</sup>) min. | Elongation on 5,65 √So (%) min. | Typical hardness values (Brinell) (see W10.7.1) | Impact energy Test temp °C | Impact energy KV<sup>(2)</sup> J min | Typical structure of matrix (see W10.9.3) |
|---|---|---|---|---|---|---|---|
| Ordinary qualities | 370 | 230 | 17 | 120-180 | - | - | Ferrite |
| Ordinary qualities | 400 | 250 | 12 | 140-200 | - | - | Ferrite |
| Ordinary qualities | 500 | 320 | 7 | 170-240 | - | - | Ferrite/Perlite |
| Ordinary qualities | 600 | 370 | 3 | 190-270 | - | - | Ferrite/Perlite |
| Ordinary qualities | 700 | 420 | 2 | 230-300 | - | - | Perlite |
| Ordinary qualities | 800 | 480 | 2 | 250-350 | - | - | Perlite or Tempered structure |
| Special qualities | 350 | 220 | 22<sup>(3)</sup> | 110-170 | +20 | 17(14) | Ferrite |
| Special qualities | 400 | 250 | 18<sup>(3)</sup> | 140-200 | +20 | 14(11) | Ferrite |
...
## W10.10 Rectification of defective castings
