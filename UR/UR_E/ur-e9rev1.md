I will locate the specified PDF file and then read its content to convert it into a well-formatted Markdown document.
I will now read the PDF file's content and convert it into Markdown, preserving all text, tables, headings, and structures faithfully.
# E9 Earthing and bonding of cargo tanks/process plant/piping systems for the control of static electricity

**(1988) (Rev.1 Oct 2012)**

E9.1 The hazard of an incendiary discharge due to the build-up of static electricity resulting from the flow of liquids/gases/vapours can be avoided if the resistance between the cargo tanks/process plant/piping systems and the hull of the ship is not greater than 10^6 ohm.
