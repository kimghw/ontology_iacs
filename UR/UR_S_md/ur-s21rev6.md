...
(Corr.1 Oct 2004)
(Rev.5 May 2010)
(Rev.6 Jan 2023 Complete Revision)
...
1 APPLICATION AND DEFINITIONS ........................................................................ 4
1.1 Application ........................................................................................................... 4
1.2 Definitions ............................................................................................................ 4
    1.2.1 Hatch cover types ........................................................................................ 4
    1.2.2 Positions ....................................................................................................... 5
1.3 Material ................................................................................................................ 5
1.4 General requirements .......................................................................................... 5
1.5 Net scantling approach ........................................................................................ 5

2 HATCH COVER AND COAMING LOAD MODEL ................................................... 6
2.1 Vertical weather design load ............................................................................... 6
2.2 Horizontal weather design load ........................................................................... 8
    2.2.1 General horizontal weather design load .................................................... 8
    2.2.2 Horizontal weather design load applicable to coamings of Type-2 ships .. 10
2.3 Cargo loads ........................................................................................................ 11
    2.3.1 Distributed loads ....................................................................................... 11
    2.3.2 Point loads ................................................................................................. 11
2.4 Container loads .................................................................................................. 11
    2.4.1 General ...................................................................................................... 11
    2.4.2 Corner loads for ship in upright condition ................................................ 11
    2.4.3 Corner loads for ship in heel condition ..................................................... 12
    2.4.4 Load cases with partial loading ................................................................. 13
    2.4.5 Mixed stowage of 20' and 40' containers on hatch cover ....................... 14
2.5 Loads due to elastic deformations of the ship's hull ......................................... 14

3 HATCH COVER STRENGTH CRITERIA ................................................................ 15
3.1 Permissible stresses and deflections ................................................................ 15
    3.1.1 Yield strength ............................................................................................ 15
    3.1.2 Deflection .................................................................................................. 16
3.2 Local net plate thickness .................................................................................... 16
    3.2.1 Local net plate thickness of hatch covers for wheel loading ................... 17
    3.2.2 Lower plating of double skin hatch covers and box girders .................... 17
3.3 Net scantling of stiffeners .................................................................................. 17
3.4 Net scantling of primary supporting members ................................................. 19
    3.4.1 Primary supporting members ................................................................... 19
    3.4.2 Edge girders (Skirt plates) ......................................................................... 19
3.5 Strength calculations .......................................................................................... 19
    3.5.1 General requirements for FEM calculations ............................................ 20
3.6 Buckling strength of hatch cover structures ..................................................... 20
    3.6.1 General ...................................................................................................... 20
    3.6.2 Slenderness requirements ........................................................................ 21
    3.6.3 Buckling requirements .............................................................................. 21

4 DETAILS OF HATCH COVERS ............................................................................... 24
4.1 Container foundations on hatch covers ............................................................ 24
4.2 Weather tightness ............................................................................................. 24
    4.2.1 Packing material (General) ....................................................................... 24
    4.2.2 Dispensation of weather tight gaskets .................................................... 24
    4.2.3 Drainage arrangements ............................................................................ 25

5 HATCH COAMING STRENGTH AND LOCAL DETAILS ........................................ 25
5.1 Local net plate thickness of coamings ............................................................... 25
5.2 Net scantling of stiffeners of coamings ............................................................. 26
5.3 Coaming stays .................................................................................................... 27
    5.3.1 Coaming stay section modulus and web thickness ................................. 27
    5.3.2 Coaming stays under friction load ............................................................ 28
5.4 Further requirements for hatch coamings ........................................................ 28
    5.4.1 Longitudinal strength ................................................................................ 28
    5.4.2 Local details .............................................................................................. 29
    5.4.3 Stays .......................................................................................................... 29
    5.4.4 Extend of coaming plates ......................................................................... 29
    5.4.5 Drainage arrangement at the coaming .................................................... 29

6 CLOSING ARRANGEMENTS ................................................................................. 30
6.1 Securing devices ................................................................................................ 30
    6.1.1 General ...................................................................................................... 30
    6.1.2 Rod cleats .................................................................................................. 30
    6.1.3 Hydraulic cleats ......................................................................................... 30
    6.1.4 Cross-sectional area of the securing devices .......................................... 30
    6.1.5 Anti lifting devices .................................................................................... 31
6.2 Hatch cover supports, stoppers and supporting structures ............................. 31
    6.2.1 Horizontal mass forces ............................................................................. 31
    6.2.2 Hatch cover supports ................................................................................ 32
    6.2.3 Hatch cover stoppers ................................................................................ 33

7 CORROSION ADDITION AND STEEL RENEWAL ................................................ 34
7.1 Corrosion addition for hatch covers and hatch coamings ................................ 34
7.2 Steel renewal ...................................................................................................... 35
...
- **Single skin cover**
    ...
    A hatch cover made of steel or equivalent material that is designed to comply with ICLL Regulation 16. The cover has continuous top and side plating, but is open underneath with the stiffening structure exposed. The cover is weathertight and fitted with gaskets and clamping devices unless such fittings are specifically excluded.

- **Double skin cover**

    A hatch cover as above but with continuous bottom plating such that all the stiffening structure and internals are protected from the environment.

- **Pontoon type cover**

    A special type of portable cover, secured weathertight by tarpaulins and battening devices. Such covers are to be designed in accordance with ICLL Regulation 15 and are not covered by this UR.

Clarification note:

Modern hatch cover designs of lift-away-covers (also called lift-on/lift-off, or just simply LoLo covers) are in many cases called pontoon covers. This definition does not fit to the definition above. Modern lift-away hatch cover designs should belong to one of the two categories-single skin covers or double skin cover.
...
Unless otherwise quoted, the thicknesses *t* of the following sections are net thicknesses.

The net thicknesses are the member thicknesses necessary to obtain the minimum net scantlings required by 3 and 5.

The required gross thicknesses are obtained by adding corrosion additions, *t<sub>c</sub>*, given in Tab.8 in 7.1.
...
- *L<sub>LL</sub>*  = freeboard length of ship, in m, as defined in ICLL Regulation 3

- *x*  = longitudinal coordinate of midpoint of assessed structural member measured from aft end of length *L* or *L<sub>LL</sub>*, as applicable

- *D<sub>min</sub>*  = the least moulded depth, in m, as defined in ICLL Regulation 3

- *h<sub>N</sub>*  = standard superstructure height in m
    = $1{,}05 + 0{,}01 L_{LL}$, $1{,}8 \le h_N \le 2{,}3$

### 2.1 Vertical weather design load

The pressure *P<sub>HC</sub>*, in kN/m², on the hatch cover panels is given by ICLL. This may be taken from Tab.1. The vertical weather design load needs not to be combined with cargo loads according to 2.3 and 2.4.

In Fig.1 the positions 1 and 2 are illustrated for an example ship.

Where an increased freeboard is assigned, the design load for hatch covers according to Tab.1 on the actual freeboard deck may be as required for a superstructure deck, provided the summer freeboard is such that the resulting draught will not be greater than that corresponding to the minimum freeboard calculated from an assumed freeboard deck situated at a distance at least equal to the standard superstructure height *h<sub>N</sub>* below the actual freeboard deck, see Fig.2.
...
**Tab.1 Design load *P<sub>HC</sub>* of weather deck hatches**

| Position | Design load *P<sub>HC</sub>* [kN/m²] | |
|---|---|---|
| | $\dfrac{x}{L_{LL}} \le 0{.}75$ | $0{.}75 < \dfrac{x}{L_{LL}} \le 1{.}0$ |
| 1 | **for 24 m ≤ *L<sub>LL</sub>* ≤ 100 m**<br><br>$\dfrac{9{.}81}{76}(1{.}5 L_{LL} + 116)$ | **on freeboard deck**<br><br>$\dfrac{9{.}81}{76}\left[(4{.}28 L_{LL} + 28)\dfrac{x}{L_{LL}} - 1{.}71 L_{LL} + 95\right]$<br><br>**upon exposed superstructure decks located at least one superstructure standard height above the freeboard deck**<br><br>$\dfrac{9{.}81}{76}(1{.}5 L_{LL} + 116)$ |
| 1 | **for *L<sub>LL</sub>* > 100 m**<br><br>$9{.}81 \times 3{.}5$ | **on freeboard deck for type B ships according to ICLL**<br><br>$9{.}81\left[(0{.}0296 \cdot L_1 + 3{.}04) \cdot \dfrac{x}{L_{LL}} - 0{.}0222 \cdot L_1 + 1{.}22\right]$<br><br>**on freeboard deck for ships with less freeboard than type B according to ICLL**<br><br>$9{.}81\left[(0{.}1452 L_1 - 8{.}52)\dfrac{x}{L_{LL}} - 0{.}1089 L_1 + 9{.}89\right]$<br><br>$L_1 = L_{LL}$ but not more than 340 m<br><br>**upon exposed superstructure decks located at least one superstructure standard height above the freeboard deck**<br><br>$9{.}81 \times 3{.}5$ |
| 2 | **for 24 m ≤ *L<sub>LL</sub>* ≤ 100 m**<br><br>$\dfrac{9{.}81}{76}(1{.}1 L_{LL} + 87{.}6)$ | |
| 2 | **for *L<sub>LL</sub>* > 100 m**<br><br>$9{.}81 \times 2{.}6$ | |
| 2 | **upon exposed superstructure decks located at least one superstructure standard height above the lowest Position 2 deck**<br><br>$9{.}81 \times 2{.}1$ | |
...
- \*\* reduced load upon exposed superstructure decks of vessels with *L<sub>LL</sub>* > 100 m located at least one superstructure standard height above the lowest Position 2 deck

### 2.2 Horizontal weather design load

#### 2.2.1 General horizontal weather design load

The horizontal weather design load *P<sub>A</sub>*, in kN/m², for determining the scantlings of outer edge girders (skirt plates) of weather deck hatch covers and of hatch coamings is:

$$P_A = f_n f_c (f_b c_L C_w - z)$$

- *C<sub>w</sub>*  
    = $\dfrac{L}{25} + 4{.}1$  for $L < 90\,\text{m}$
    = $10{.}75 - \left(\dfrac{300 - L}{100}\right)^{1{.}5}$  for $90\,m \le L < 300\,m$
    = $10{.}75$  for $300\,m \le L < 350\,m$
    = $10{.}75 - \left(\dfrac{L - 350}{150}\right)^{1{.}5}$  for $350\,m \le L \le 500\,m$

- *c<sub>L</sub>*  
    = $\sqrt{\dfrac{L}{90}}$  for $L < 90\,\text{m}$
    = $1$  for $L \ge 90\,m$

- *f<sub>n</sub>*  
    = $20 + \dfrac{L_1}{12}$  for unprotected front coamings and hatch cover skirt plates.
    = $10 + \dfrac{L_1}{12}$  for unprotected front coamings and hatch cover skirt plates, where the distance from the actual freeboard deck to the summer load line exceeds the minimum non-corrected tabular freeboard according to ICLL by at least one standard superstructure height *h<sub>N</sub>*.
    = $5 + \dfrac{L_1}{15}$  for side and protected front coamings and hatch cover skirt plates.
    = $7 + \dfrac{L_1}{100} - 8\dfrac{x'}{L}$  for aft ends of coamings and aft hatch cover skirt plates abaft amidships.
    = $5 + \dfrac{L_1}{100} - 4\dfrac{x'}{L}$  for aft ends of coamings and aft hatch cover skirt plates forward of amidships.

- *L<sub>1</sub>*  = *L*, need not be greater than 300 m.

- *f<sub>b</sub>*  
    = $1{.}0 + \left(\dfrac{\tfrac{x'}{L} - 0{.}45}{C_B + 0{.}2}\right)^2$  for $\dfrac{x'}{L} < 0{.}45$
    = $1{.}0 + 1{.}5 \cdot \left(\dfrac{\tfrac{x'}{L} - 0{.}45}{C_B + 0{.}2}\right)^2$  for $\dfrac{x'}{L} \ge 0{.}45$

$0{.}6 \le C_B \le 0{.}8$, when determining scantlings of aft ends of coamings and aft hatch cover skirt plates forward of amidships, *C<sub>B</sub>* need not be taken less than 0.8.
...
The design load *P<sub>A</sub>* is not to be taken less than the minimum values *P<sub>A-min</sub>* given in Tab.2.

**Tab.2  Minimum design load *P<sub>A-min</sub>***

| *L* | *P<sub>A-min</sub>* in kN/m² for | |
|---|---|---|
| | unprotected fronts | elsewhere |
| ≤ 50 | 30 | 15 |
| > 50<br>< 250 | $25 + \dfrac{L}{10}$ | $12{.}5 + \dfrac{L}{20}$ |
| ≥ 250 | 50 | 25 |

#### 2.2.2 Horizontal weather design load applicable to coamings of Type-2 ships

The pressure *P<sub>Coam</sub>*, in kN/m², on the No. 1 forward transverse hatch coaming is given by:

- *P<sub>Coam</sub>* = 220, when a forecastle is fitted in accordance with UR S28
    = 290 in the other cases

The pressure *P<sub>Coam</sub>*, in kN/m², on the other coamings is given by:

*P<sub>Coam</sub>* = 220

***Note:***
The horizontal weather design loads P<sub>A</sub> and P<sub>Coam</sub> need not be included in the direct strength calculation of the hatch cover, unless it is utilized for the design of substructures of horizontal support according to 6.2.3.

### 2.3 Cargo loads

#### 2.3.1 Distributed loads

The load on hatch covers due to distributed cargo loads *P<sub>L</sub>*, in kN/m², resulting from heave and pitch (i.e. ship in upright condition) is to be determined according to the following formula:

$$P_L = P_{Cargo}(1 + a_V)$$

where:

*P<sub>Cargo</sub>* = uniform cargo load in kN/m²

*a<sub>V</sub>* = vertical acceleration addition as follows:

$$a_V = F \cdot m$$

- $F = 0{.}11 \dfrac{v_0}{\sqrt{L}}$

- *m*  
    = $m_0 - 5(m_0 - 1)\dfrac{x}{L}$  for $0 \le \dfrac{x}{L} \le 0{.}2$
    = $1{.}0$  for $0{.}2 < \dfrac{x}{L} \le 0{.}7$
    = $1 + \dfrac{m_0 + 1}{0{.}3}\left[\dfrac{x}{L} - 0{.}7\right]$  for $0{.}7 < \dfrac{x}{L} \le 1{.}0$

- *m<sub>0</sub>*  = $1{.}5 + F$

- *v<sub>0</sub>*  = maximum speed at summer load line draught, *v<sub>0</sub>* is not to be taken less than $\sqrt{L}$ in knots

#### 2.3.2 Point loads

The load *P*, in kN, due to a concentrated force *P<sub>S</sub>*, in kN, except for container load, resulting from heave and pitch (i.e. ship in upright condition) is to be determined as follows:
...
$$P = 9{.}81 \dfrac{M}{4}(1 + a_V)$$

where:

- *a<sub>V</sub>*  = acceleration addition according to 2.3.1.

- *M*  = maximum designed mass of container stack in t.

#### 2.4.3 Corner loads for ship in heel condition

The loads, in kN, applied at each corner of a container stack, and resulting from heave, pitch, and the ship's rolling motion (i.e. ship in heel condition) are to be determined as follows, (see also Fig.3):

$$A_z = 9{.}81 \dfrac{M}{2}(1 + a_V)\left(0{.}45 - 0{.}42 \dfrac{h_m}{b}\right)$$

$$B_z = 9{.}81 \dfrac{M}{2}(1 + a_V)\left(0{.}45 + 0{.}42 \dfrac{h_m}{b}\right)$$
...
- *h<sub>m</sub>*  = designed height of centre of gravity of stack above hatch cover top in m, may be calculated as weighted mean value of the stack, where the centre of gravity of each tier is assumed to be located at the centre of each container,
    = $\sum (z_i \cdot W_i) / M$

- *z<sub>i</sub>*  = distance from hatch cover top to the centre of *i*-th container in m.

- *W<sub>i</sub>*  = weight of *i*-th container in t

- *b*  = distance between midpoints of foot points in m.

- *A<sub>z</sub>, B<sub>z</sub>*  = support forces in *z*-direction at the forward and aft stack corners.

- *B<sub>y</sub>*  = support force in *y*-direction at the forward and aft stack corners.

Values of *A<sub>Z</sub>* and *B<sub>Z</sub>* applied for the assessment of hatch cover strength are to be shown in the drawings of the hatch covers.

***Note:***
It is recommended that container loads as calculated above are considered as limit for foot point loads of container stacks in the calculations of cargo securing (container lashing).

![Fig.3 Forces due to container loads: diagram of a container stack showing support forces A_z, B_z, B_y at forward and aft stack corners, with dimensions h_m, z_i, and b between foot points, and centre of gravity W_i and M](assets/ur-s21rev6/part01-fig-064.jpg)
...
| Heel direction | ← | → |
|---|---|---|
| Hatch covers supported by the longitudinal hatch coaming with all container stacks located completely on the hatch cover | (container stacks loaded, heel left) | (container stacks loaded, heel right) |
| Hatch covers supported by the longitudinal hatch coaming with the outermost container stack supported partially by the hatch cover and partially by container stanchions | (outermost stack omitted, heel left) | (outermost stack omitted, heel right) |
| Hatch covers not supported by the longitudinal hatch coaming (center hatch covers) | (center cover loading, heel left) | (center cover loading, heel right) |
...
- *R<sub>eH</sub>* : Specified minimum yield stress, in N/mm², of the material.
...
For steels with a minimum yield stress of more than 355 N/mm², the value of *R<sub>eH</sub>* to be applied throughout this requirement is subject to the individual classification society but is not to be more than the minimum yield stress of the material.
...
| Hatch cover structure | Other loads, as defined in 2.2 to 2.5 | $0{.}90\,R_{eH}$ for static+dynamic load case<br>$0{.}72\,R_{eH}$ for static load case |

#### 3.1.2 Deflection

The vertical deflection of primary supporting members due to the vertical weather design load according to 2.1 is to be not more than $0{.}0056 l_g$, where *l<sub>g</sub>* is the greatest span of primary supporting members.
...
$$t = 0{.}0158 F_p s \sqrt{\dfrac{P}{0{.}95 R_{eH}}}$$

and to be not less than 1% of the spacing of the stiffener or 6 mm if that be greater.

- *F<sub>p</sub>*  = factor for combined membrane and bending response
    = $1{.}5$ in general
    = $1{.}9 \dfrac{\sigma}{\sigma_a}$, for $\dfrac{\sigma}{\sigma_a} \ge 0{.}8$ for the attached plate flange of primary supporting members

where:

- *s*  = stiffener spacing in mm

- *P*  = pressure *P<sub>HC</sub>* and *P<sub>L</sub>*, in kN/m², as defined in 2.
...
![Fig.4 Determination of normal stress of the hatch cover plating: plate field showing coordinate axes x and y with normal stresses σ_x, σ_y and the relation σ = max(σ_x, σ_y) over the shaded region representing the plate element](assets/ur-s21rev6/part01-fig-066.png)
...
The net section modulus *Z* and net shear area *A<sub>shr</sub>* of uniformly loaded hatch cover stiffeners constraint at both ends must not be less than:

$$Z = \dfrac{P s l^2}{f_{bc} \sigma_a}, \text{in cm}^3,$$

$$A_{shr} = \dfrac{8{.}7 P s l}{\sigma_a} 10^{-3}, \text{in cm}^2,$$
...
- *f<sub>bc</sub>*  = boundary coefficient of stiffener, taken equal to:
    *f<sub>bc</sub>* = 8, in the case of stiffener simply supported at both ends or simply supported at one end and clamped at the other end
    *f<sub>bc</sub>* = 12, in the case of stiffener clamped at both ends.
...
$$t = 0{.}0158 s \sqrt{\dfrac{P_A}{0{.}95 R_{eH}}}$$

$$t = 8{.}5 s \times 10^{-3} \text{ in mm}$$

$$t_{min} = 5 \text{ mm}$$

where:

- *P<sub>A</sub>*  = horizontal pressure as defined in 2.2.1
...
![Fig.5 Example of hatch cover fitted with U-type stiffeners: cross section of hatch cover plate of thickness t_p with two trapezoidal U-type stiffeners below, showing parameters b_1, b_2, b_f, h_w, t_w and t_f](assets/ur-s21rev6/part01-fig-067.png)
...
| Structural elements | Assessment method<sup>(1)(2)</sup> | Normal panel definition |
|---|---|---|
...
| Web of transverse/longitudinal girder (double skin type) | SP-B<sup>(3)</sup> | Length: between PSM<br>Width: full web depth |
...
![Fig.6 Hatch cover top/bottom plating structures: FE mesh visualization of a hatch cover top/bottom plating with coloured panels and an SP-A labelled region indicating the stiffened panel definition between girders](assets/ur-s21rev6/part01-fig-069.png)

Fig.6 Hatch cover top/bottom plating structures

![Fig.7 Hatch cover webs of primary supporting members: isometric FE mesh view of hatch cover webs with an UP-B labelled region identifying an unstiffened panel between local stiffeners and primary supporting members](assets/ur-s21rev6/part01-fig-071.png)
...
|---|---|---|
| Plates and stiffeners<br>Web of PSM | External pressure, as defined in 2.1 | 0.80 |
| Plates and stiffeners<br>Web of PSM | Other loads, as defined in 2.2 to 2.5 | 0.90 for static+dynamic load case<br>0.72 for static load case |
...
- The exposed deck on which the hatch covers are located is situated above a depth *H(x)*. *H(x)* is to be shown to comply with the following criteria:
  ...
  - *T<sub>fb</sub>* = draught, in m, corresponding to the assigned summer load line
  - *f<sub>b</sub>* = minimum required freeboard, in m, determined in accordance with ICLL Reg. 28 as modified by further regulations as applicable
  - *h*  = $4{.}6$ m for $\dfrac{x}{L_{LL}} \le 0{.}75$
        = $6{.}9$ m for $\dfrac{x}{L_{LL}} > 0{,}75$
...
- Where a hatch is covered by several hatch cover panels the clear opening of the gap in between the panels shall be not wider than 50mm.

- The labyrinths and gaps between hatch cover panels shall be considered as unprotected openings with respect to the requirements of intact and damage stability calculations.

- With regard to drainage of cargo holds and the necessary fire-fighting system reference is made to the sections *Piping Systems, Valves and Pumps* and *Fire Protection and Fire Extinguishing Equipment* of the individual classification society's rules.

- Bilge alarms should be provided in each hold fitted with non-weathertight covers.

- Furthermore, Chapter 3 of IMO MSC/Circ. 1087 is to be referred to concerning the stowage and segregation of containers containing dangerous goods.

#### 4.2.3 Drainage arrangements

Cross-joints of multi-panel covers are to be provided with efficient drainage arrangements.
...
$$t = 0{.}0142 s \sqrt{\dfrac{P_A}{0{.}95 R_{eH}}} \text{in mm}$$

$$t_{min} = 6 + \dfrac{L_1}{100} \text{ mm}$$

(2) For Type-2 ships:

$$t = 0{.}016 s \sqrt{\dfrac{P_{coam}}{0{.}95 R_{eH}}} \text{in mm,}$$

$$t_{min} = 9{.}5 \text{ mm}$$

where:

- *P<sub>A</sub>* = pressure, in kN/m², as defined in S21.2.2.1

- *P<sub>coam</sub>* = pressure, in kN/m², as defined in S21.2.2.2

- *s* = stiffener spacing in mm

- *L<sub>1</sub>* = *L*, need not be taken greater than 300 m
...
The stiffeners must be continuous at the coaming stays. For stiffeners with both ends constraint the elastic net section modulus Z in cm<sup>3</sup> and net shear area *A<sub>shr</sub>* in cm², calculated on the basis of net thickness, must not be less than:

(1) For Type-1 ships:

$$Z = \dfrac{P_A s l^2}{f_{bc} R_{eH}}$$

$$A_{shr} = \dfrac{P_A s l}{R_{eH}} 10^{-2}$$

where:

- *f<sub>bc</sub>*  = 12 in general
...
$$t_{gr} = 19{.}6 \sqrt{\dfrac{P_A s (l - 0{.}0005 s)}{1000 R_{eH}}} \text{ in mm}$$

(2) For Type-2 ships:

$$Z = 1{.}21 \dfrac{P_{Coam} s l^2}{f_{bc} c_p R_{eH}}$$

where:

- *f<sub>bc</sub>* = 16 in general
...
- *P<sub>A</sub>*  = pressure in kN/m² as defined in 2.2.1

- *P<sub>Coam</sub>*  = pressure in kN/m² as defined in 2.2.2

- *c<sub>p</sub>*  = ratio of the plastic section modulus to the elastic section modulus of the stiffeners with an attached plate breadth, in mm, equal to 40 t, where t is the plate net thickness
...
At the connection with deck, the net section modulus *Z*, in cm<sup>3</sup>, and the net thickness *t<sub>w</sub>*, in mm, of the coaming stays designed as beams with flange (examples 1 and 2 are shown in Fig.8) are to be taken not less than:

$$Z = \dfrac{P s_c H_c^2}{1{.}9 R_{eH}} \text{ in cm}^3$$

$$t_w = \dfrac{2 P s_c H_c}{h R_{eH}} \text{ in mm}$$

where:

- *H<sub>C</sub>*  = stay height, in m

- *s<sub>c</sub>*  = stay spacing, in mm

- *h*  = stay depth, in mm, at the connection with the deck

- *P*  = pressure on coaming, in kN/m², taken as *P<sub>A</sub>* defined in 2.2.1 in general and as *P<sub>Coam</sub>* defined in 2.2.2 for Type-2 ships.
...
![Fig.8 Examples of coaming stays: four schematic side-view examples (Example 1, Example 2, Example 3, Example 4) showing different coaming stay designs connecting hatch coaming to the deck](assets/ur-s21rev6/part01-fig-073-merged.png)
...
Longitudinal hatch coamings with a length exceeding $0{.}1 L$ m are to be provided with tapered brackets or equivalent transitions and a corresponding substructure at both ends. At the end of the brackets they are to be connected to the deck by full penetration welds of minimum 300 mm in length.
...
![Fig.9 Example for a hatch side girder: cross-sectional drawing showing hatch coaming at the top, hatch side girder beneath, and a deck beam to the right, illustrating the extended hatch side girder arrangement](assets/ur-s21rev6/part01-fig-082.png)
...
Correspondingly, the stiffness of edge girders is to be sufficient to maintain adequate sealing pressure between securing devices. The moment of inertia, in cm<sup>4</sup>, of edge girders is not to be less than:
...
- *S<sub>SD</sub>*  = spacing between securing devices in m, not to be taken less than 2 m.

$$k_l = \left(\dfrac{235}{R_{eH}}\right)^e$$

*R<sub>eH</sub>* is the minimum yield strength of the material in N/mm², but is not to be taken greater than $0{.}7 R_m$, where *R<sub>m</sub>* is the tensile strength of the material in N/mm².

- *e*  = 0.75 for *R<sub>eH</sub>* > 235 N/mm²
    = 1.00 for *R<sub>eH</sub>* ≤ 235 N/mm²

Rods or bolts are to have a gross diameter not less than 19 mm for hatchways exceeding 5 m² in area.

Securing devices of special design in which significant bending or shear stresses occur may be designed as anti-lifting devices according to 6.1.5. The packing line pressure *q* is to be specified, and as load, *q* multiplied by the spacing between securing devices *S<sub>SD</sub>* is to be applied.
...
$$\sigma_{vm} = \dfrac{150}{k_l} \text{ in N/mm}^2$$
...
![Fig.10 Lifting forces at a hatch cover: side-view schematic of stacked containers on a hatch cover showing alternating upward A_Z and downward B_Z support forces at each stack and the resulting lifting force acting on the hatch cover](assets/ur-s21rev6/part01-fig-083.png)
...
- $a_X = 0{.}2 g$ in longitudinal direction

- $a_Y = 0{.}5 g$ in transverse direction
...
**Tab. 7 Permissible nominal surface pressure *P<sub>n</sub>***

| Support material | *P<sub>n</sub>* [N/mm²] when loaded by | |
|---|---|---|
...
Irrespective of the arrangement of stoppers, the supports must be able to transmit the following force *P<sub>h</sub>* in the longitudinal and transverse direction:

$$P_h = \mu \cdot \dfrac{P_V}{\sqrt{d}}$$

where:

- *P<sub>v</sub>*  = vertical supporting force
...
For substructures and adjacent structures of supports subjected to horizontal forces *P<sub>h</sub>*, fatigue strength is to be considered according to the individual class society's rules.
...
ii. calculated in the throat of the stopper welds is not to exceed the allowable value of $0{.}8 R_{eH}$.

## 7 Corrosion addition and steel renewal

### 7.1 Corrosion addition for hatch covers and hatch coamings

The scantling requirements of the above sections imply the following general corrosion additions *t<sub>c</sub>*:

**Tab. 8 Corrosion additions *t<sub>c</sub>* for hatch covers and hatch coamings**

| Application | Structure | *t<sub>c</sub>* [mm] |
|---|---|---|
| Weather deck cargo hatches of container ships, car carriers, paper carriers, passenger vessels | Hatch covers | 1.0 |
| Weather deck cargo hatches of container ships, car carriers, paper carriers, passenger vessels | Hatch coamings | according to individual class society's rules |
| Weather deck cargo hatches of Type-2 ships | Hatch covers in general | 2.0 |
| Weather deck cargo hatches of Type-2 ships | Top and bottom plating of double skin hatch covers | 2.0 |
| Weather deck cargo hatches of Type-2 ships | Internal structure of double skin hatch covers | 1.5 |
| Weather deck cargo hatches of Type-2 ships | Hatch coamings and coaming stays | 1.5 |
| Weather deck cargo hatches of all other ship types covered by this UR | Hatch covers in general | 2.0 |
| Weather deck cargo hatches of all other ship types covered by this UR | Weather exposed plating and bottom plating of double skin hatch covers | 1.5 |
| Weather deck cargo hatches of all other ship types covered by this UR | Internal structure of double skin hatch covers and closed box girders | 1.0 |
| Weather deck cargo hatches of all other ship types covered by this UR | Hatch coamings not part of the longitudinal hull structure | 1.5 |
| Weather deck cargo hatches of all other ship types covered by this UR | Hatch coamings part of the longitudinal hull structure | according to individual class society's rules |
| Weather deck cargo hatches of all other ship types covered by this UR | Coaming stays and stiffeners | 1.5 |

### 7.2 Steel renewal

Steel renewal is required where the gauged thickness is less than *t<sub>net</sub>* + 0.5 mm for

- single skin hatch covers,

- the plating of double skin hatch covers, and

- coaming structures the corrosion additions *t<sub>c</sub>* of which are provided in Tab. 8.

Where the gauged thickness is within the range *t<sub>net</sub>* + 0.5 mm and *t<sub>net</sub>* + 1.0 mm, coating (applied in accordance with the coating manufacturer's requirements) or annual gauging may be adopted as an alternative to steel renewal. Coating is to be maintained in GOOD condition, as defined in UR Z10.2.1.2.

For the internal structure of double skin hatch covers, thickness gauging is required when hatch cover top or bottom plating renewal is to be carried out or when this is deemed necessary, at the discretion of the individual society's surveyor, on the basis of the plating corrosion or deformation condition. In these cases, steel renewal for the internal structures is required where the gauged thickness is less than *t<sub>net</sub>*.

For corrosion addition *t<sub>c</sub>* = 1.0 mm the thickness for steel renewal is *t<sub>net</sub>* and the thickness for coating or annual gauging is when gauged thickness is between *t<sub>net</sub>* and *t<sub>net</sub>* + 0.5 mm.

For coaming structures, the corrosion additions *t<sub>c</sub>* of which are not provided in Tab. 8, steel renewal and coating or annual gauging are to be in accordance with the individual classification society's requirements.
