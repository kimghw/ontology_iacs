...
*Note: YP36 YP40 and YP47 refers to the minimum specified yield strength of steel 355, 390 and 460 N/mm<sup>2</sup>, respectively as defined in UR W11 and W31.*
...
![Fig.1 Upper Flange Longitudinal Structural Members - schematic showing deck longitudinals, side longitudinals, inner hull longitudinals and bulkhead longitudinals on a container ship upper flange cross section](assets/ur-s33rev3/part01-fig-000.png)
...
![Fig.2 Other Weld Areas - schematic locating the seven numbered fillet welds between hatch side coaming, upper deck plating, longitudinals and attachments such as pad plate](assets/ur-s33rev3/part01-fig-001.png)

Fig.2 Other Weld Areas
...
| Hatch coaming side | 80 < t ≤ 100 | Steel grade YP 40 or 47 with suffix BCA2 |
...
## Measures for Extremely Thick Steel Plates
...
| Yield Strength (kgf/mm<sup>2</sup>) | Thickness (mm) | Option | Measure 1 | Measure 2 | Measure 3+4 | Measure 5 |
|---|---|---|---|---|---|---|
| 36 | 50 < t ≤ 85 | - | N.A. | N.A. | N.A. | N.A. |
| 36 | 85 < t ≤ 100 | - | X | N.A. | N.A. | N.A. |
| 40 | 50 < t ≤ 85 | - | X | N.A. | N.A. | N.A. |
| 40 | 85 < t ≤ 100 | A | X | N.A. | X | X |
| 40 | 85 < t ≤ 100 | B | X * | N.A.** | N.A. | X |
| 47 (FCAW) | 50 < t ≤ 100 | A | X | N.A. | X | X |
| 47 (FCAW) | 50 < t ≤ 100 | B | X * | N.A.** | N.A. | X |
