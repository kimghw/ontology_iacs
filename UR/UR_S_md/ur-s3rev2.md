...
$p$ = design pressure in N/mm<sup>2</sup> (MPa)

$$a = 2.0 + \frac{L_1}{120} \quad \text{for lowest tier of unprotected fronts}$$
...
$$a = 1.0 + \frac{L_1}{120} \quad \text{for 2}^{nd}\text{ tier of unprotected fronts}$$

$$a = 0.5 + \frac{L_1}{150} \quad \text{for 3}^{rd}\text{ tier of unprotected fronts and for sides and protected fronts}$$

$$a = 0.7 + \frac{L_1}{1000} - 0.8\frac{x}{L} \quad \text{for aft ends aft of amidships}$$

$$a = 0.5 + \frac{L_1}{1000} - 0.4\frac{x}{L} \quad \text{for aft ends forward of amidships}$$

$L$, $L_1$ = length of ships in metres, $L_1$ need not be taken greater than 300 m

$$b = 1.0 + \left(\frac{x/L - 0.45}{C_b + 0.2}\right)^2 \quad \text{for } x / L \leq 0.45$$

$$b = 1.0 + 1.5\left(\frac{x/L - 0.45}{C_b + 0.2}\right)^2 \quad \text{for } x / L > 0.45$$
...
When determining sides of a deckhouse, the deckhouse is to be subdivided into parts of approximately equal length, not exceeding 0,15$L$ each and $x$ is to be taken as the distance between AP and the centre of each part considered.

$$f = \frac{L}{10}e^{-L/300} - \left[1 - \left(\frac{L}{150}\right)^2\right] \quad \text{for } L < 150 \text{ m}$$

$$f = \frac{L}{10}e^{-L/300} \quad \text{for } 150 \text{ m} < L < 300 \text{ m}$$

$$f = 11.03 \quad \text{for } L > 300 \text{ m}$$
...
| $L$(m)          | $p$ (N/mm<sup>2</sup> or MPa) Lowest tier of unprotected fronts | $p$ (N/mm<sup>2</sup> or MPa) Elsewhere |
|-----------------|-----------------------------------------------------------------|-----------------------------------------|
| $L \leq 50$     | 0.03                                                            | 0.015                                   |
| $50 < L < 250$  | $0.025 + 10^{-4}L$                                              | $0.0125 + 0.5 \times 10^{-4}L$          |
| $L \geq 250$    | 0.05                                                            | 0.025                                   |
...
$W$ = stiffener modulus (cm<sup>3</sup>)
...
$p$ = pressure in N/mm<sup>2</sup> (MPa) as defined above.
...
4.0 + $L_1$/100 for upper tiers, but not less than 5.0 mm

For ships with $L_1$<65m, the minimum thickness of plating should be as follows:

$t_{min}$ = 5mm for the lowest unprotected front
4mm for all other cases
