...
![Figure 1. Arrangement of Stiffeners - diagrams showing stiffener layouts for nominal sizes 630x630, 630x830, 830x830, 830x630, 1030x1030, and 1330x1330, with legend indicating hinge, securing device / metal to metal contact, primary stiffener, and secondary stiffener](assets/ur-s26rev5/part01-fig-000.png)

Figure 1. Arrangement of Stiffeners

![Figure 2. Example of a Primary Securing Device - cross-sectional diagram of a butterfly nut toggle bolt clamp assembly with labeled components including M20 bolt, fork (clamp) plate of min 16 mm thickness, hatch cover, gasket, hatch coaming, bearing pad, stiffener, and inner edge stiffener (dimensions in millimeters)](assets/ur-s26rev5/part01-fig-001.png)
...
Figure 2. Example of a Primary Securing Device
