...
![Diagram showing a fitting with a towing line turning at it; arrows labeled DESIGN LOAD ON LINE indicate the two line directions, and DESIGN LOAD ON FITTING (not more than 2 times DESIGN LOAD ON LINE) shows the resultant load on the fitting](assets/ur-a2rev5/part01-fig-000.png)
...
![Side view of a towing bitt (double bollard) showing tube height H and attachment point at H4/5 above the base, with DESIGN LOAD ON LINE arrow, and a top view of the bitt with the towing line attached by an Eye Splice](assets/ur-a2rev5/part01-fig-001.png)
...
![Top view of a mooring bitt (double bollard) with the mooring line attached in figure-of-eight fashion and DESIGN LOAD ON LINE arrow](assets/ur-a2rev5/part01-fig-002.png)

![Case a) Side view of a mooring bitt showing tube height H with the mooring line attachment point at H4/5 above the base](assets/ur-a2rev5/part01-fig-003.png)

![Case b) Side view of a mooring bitt fitted with fins on the bollard tubes, where the mooring line attachment point is taken at the location of the fins](assets/ur-a2rev5/part01-fig-004.png)
