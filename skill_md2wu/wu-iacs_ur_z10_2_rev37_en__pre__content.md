...
1.2.1 Bulk Carrier
A Bulk Carrier is a ship which is constructed generally with single deck, double bottom, topside tanks and hopper side tanks in cargo spaces, and is intended primarily to carry dry cargo in bulk. Combination carriers are included.<sup>1</sup> Ore and combination carriers are not covered by the IACS Common Structural Rules.
...
![Figure 1 - Pitting intensity diagrams showing 5%, 10%, 15%, 20% and 25% scattered pitting patterns](assets/ur-z102rev37/part01-fig-007.png)

Figure 1 - Pitting intensity diagrams

![Figure 2 - Edge corrosion examples on a flatbar stiffener and an inverted angle or built-up stiffener, with dimensions h<sub>stf</sub> and 0.25 h<sub>stf</sub> marked on attached plating](assets/ur-z102rev37/part01-fig-008.png)

Figure 2 - Edge corrosion

![Figure 3 - Grooving corrosion showing groove breadth at the weld connection between a flatbar stiffener and attached plating](assets/ur-z102rev37/part01-fig-000.png)
...
2.2.4.4 Close-up survey and thickness measurement<sup>2</sup> of the hatch cover and coaming plating and stiffeners is to be carried out as given in Table I and Table II.
...
- carrying solid bulk cargoes having a density of 1780 kg/m<sup>3</sup> and above,
...
| <sup>1)</sup> Tank/hold Nos. | <sup>2)</sup> Tank/hold protection | <sup>3)</sup> Coating condition | Remarks |
|---|---|---|---|
|  |  |  |  |

Remarks:

<sup>1)</sup> All ballast tanks and cargo holds to be listed.
...
|---|---|---|
| 1. Bottom and Side Shell plating | a. Suspect plate, plus four adjacent plates<br>b. See other tables for particulars on gauging in way of tanks and cargo holds | a. 5 point pattern for each panel between longitudinals |
...
| STRUCTURAL MEMBER | EXTENT OF MEASUREMENT | PATTERN OF MEASUREMENT |
|---|---|---|
| 1. Lower Stool | a. Transverse band within 25mm of welded connection to inner bottom<br>b. Transverse band within 25 mm of welded connection to shelf plate | a. 5 point between stiffeners over 1 metre length<br>b. Ditto |
| 2. Transverse Bulkhead | a. Transverse band at approximately mid height<br>b. Transverse band at part of bulkhead adjacent to upper deck or below upper stool shelf plate (for those ships fitted with upper stools) | a. 5 point pattern over 1 sq. metre of plating<br>b. 5 point pattern over 1 sq. metre of plating |
...
| 2. Underdeck Stiffeners | a. Transverse members<br>b. Longitudinal member | a. 5 point pattern at each end and mid span<br>b. 5 point pattern on both web and flange |
| 3. Hatch Covers | a. Side and end skirts, each 3 locations<br>b. 3 longitudinal bands outboard strakes (2) and centreline strake (1) | a. 5 point pattern at each location<br>b. 5 point measurement each band |
...
| 4. Watertight Bulkheads (WT Floors) | a. lower 1/3 of tank<br>b. upper 2/3 of tank | a. 5 point pattern over 1 sq. metre of plating<br>b. 5 point pattern alternate plates over 1 sq. metre of plating |
| 5. Web Frames | Suspect plate | 5 point pattern over 1 sq. metre of plating |
| 6. Bottom/side shell longitudinals | Minimum of three longitudinals in way of suspect areas | 3 measurements in line across web<br>3 measurements on flange |
...
| STRUCTURAL MEMBER | EXTENT OF MEASUREMENT | PATTERN OF MEASUREMENT |
|---|---|---|
| 1. Side Shell frames | Suspect frame and each adjacent | a. At each end and mid span: 5 point pattern of both web and flange<br>b. 5 point pattern within 25 mm of welded attachment to both shell and lower slope plate |
...
![Figure 1: Technical Assessment and Survey Planning Process flowchart showing inputs (drawings, reports, acceptable corrosion allowance, coating condition, usage of tanks), two parallel analysis branches for Design Related Risk and Corrosion Risk, leading to Location for Thickness Measurement and Close-Up Survey, Survey Programme, Acceptance by Class and Owner, and final Survey step](assets/ur-z102rev37/part02-fig-100.png)

Figure 1: Technical Assessment & the Survey Planning Process

![Figure 2: Hand-drawn sketch of a bulk carrier midship cross-section marking typical locations susceptible to structural damage or corrosion, including hatch end beam, upper stool, typical corrugated bulkhead, deflection areas, lower stool (especially in way of ballast hold bulkheads), and duct keel](assets/ur-z102rev37/part02-fig-101.png)

Figure 2: Typical Locations Susceptible to Structural Damage or Corrosion

![Figure 3: Area 1 damage and repair example for side shell frames and end brackets with separate bracket configuration, showing sketch of damage (fractures at termination of frame between topside tank and hopper tank) and sketch of repair (snipe frame with modified brackets, S marking sniped ends), accompanied by notes on possible causes and repair methods](assets/ur-z102rev37/part02-fig-001.png)
...
![Sketch of typical and non-typical transverse frames in cargo hold showing upper part, mid part and lower part zones with thickness gauging area A marked by a circle, used to indicate location and pattern of measurements for hold frames](assets/ur-z102rev37/part02-fig-002.png)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| FRAME NO | Org. Thk. | t<sub>REN</sub> | t<sub>COAT</sub> | t<sub>M</sub> | Diminution |  | Org. Thk. | t<sub>REN</sub> | t<sub>COAT</sub> | t<sub>M</sub> | Diminution |  | Org. Thk. | t<sub>REN</sub> | t<sub>COAT</sub> | t<sub>M</sub> | Diminution |  | Org. Thk. | t<sub>REN</sub> | t<sub>COAT</sub> | t<sub>M</sub> | Diminution |  |
...
![Simplified outline of a generic bulk carrier transverse section (unlabelled) to be used for longitudinal and transverse members where the typical bulk carrier section on Sheet 12 is not applicable, accompanied by the same legend boxes mapping numbered items to Reports TM2, TM3-BC, TM4, TM6-BC and TM7-BC](assets/ur-z102rev37/part02-fig-013-merged.png)
...
![Sketches of typical and non-typical transverse frames in cargo hold, showing thickness gauging areas at upper, mid, and lower parts](assets/ur-z102rev37/part03-fig-002.png)
...
![Diagram of typical bulk carrier transverse section with numbered structural items (1 to 34) identifying deck plating, stringer plate, sheerstrake, side shell, bilge, bottom, keel, longitudinals, girders, hopper, topside tank members, and cargo hold frames](assets/ur-z102rev37/part03-fig-000.png)
...
![Blank transverse section outline for bulk carrier, provided as an alternative template when sheet 12 diagram is not suitable](assets/ur-z102rev37/part03-fig-001.png)
...
![Diagram of typical transverse section with Areas A (side shell/hopper), B (bilge/bottom and upper corner), and D (deck) marked by dashed outlines for close-up survey and thickness measurement](assets/ur-z102rev37/part03-fig-004.png)
...
![Diagram of a cargo hold transverse bulkhead with Area C marked at the bulkhead region between upper stool/topside tank and lower stool/hopper side tank/double bottom tank](assets/ur-z102rev37/part03-fig-002.png)
...
![Diagram of deck plating between cargo hold hatch openings with Area E marked between adjacent hatch openings](assets/ur-z102rev37/part03-fig-003.png)
...
![Figure 1 and Figure 2: Vertically corrugated transverse bulkhead gauging levels — Figure 1 shows a ship without lower stool with level a and level c marked; Figure 2 shows a ship with lower stool with level b and level c marked](assets/ur-z102rev37/part03-fig-005.png)
...
![Figure 2: Pitting intensity diagrams showing five reference patterns from 5% scattered to 25% scattered pitting density on plate surfaces](assets/ur-z102rev37/part03-fig-051.png)
...
![Figure 3: Typical 5 point pattern on the web plate showing five X marks distributed across the web between the side shell and face plate, with W mm dimensions indicated](assets/ur-z102rev37/part03-fig-052.png)
...
![Figure 4: Sections a) and b) — two diagrams showing the side shell frame lower bracket with section a) at the bracket base and section b) higher up, indicating d_a = frame web depth, d_b = lower bracket web depth for determining t_REN,S, and h_B = lower bracket length](assets/ur-z102rev37/part03-fig-053.png)
