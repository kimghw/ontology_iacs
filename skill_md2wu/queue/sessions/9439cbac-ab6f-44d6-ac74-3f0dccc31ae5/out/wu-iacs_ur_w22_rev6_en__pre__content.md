...
![Figure 1 - Location of CTOD test specimens for chain, showing weld side and non-weld side sampling positions on a chain link](assets/ur-w22rev6/part01-fig-000-merged.png)

Figure 1 Location of CTOD test specimens for chain
...
1.5.5 The bar manufacturer is to provide evidence that the manufacturing process produces material that is resistant to strain ageing, temper embrittlement and for R3S, R4S and R5, hydrogen embrittlement. All test details and results are to be submitted to the Classification Society.
...
![Figure 2 - Location of CTOD test specimens showing a) D-Type Shackle circular cross section and b) Rectangular type accessories with B=t thickness and coordinate axes X longitudinal, Y transverse, Z thickness](assets/ur-w22rev6/part01-fig-002.jpg)

Figure 2 Location of CTOD test specimens: a) Circular type accessory and b) rectangular type accessory, B corresponds to the thickness of material, the grain flow is considered in the longitudinal direction X

1.6.7 Calibration of furnaces shall be verified by measurement and recording of a calibration test piece with dimensions equivalent to the maximum size of link manufactured. Thermocouples are to be placed both on the surface and in a drilled hole located to the mid thickness position of the calibration block. The furnace dimensions shall be such as to allow the whole furnace charge to be uniformly heated to the necessary temperature. Temperature uniformity surveys of heat treatment furnaces for forged and cast components shall be carried out according to API Spec 6A/ISO 10423 Annex M or ASTM A991. The initial survey shall be carried out with maximum charge (load) in the furnace. Subsequent surveys shall be carried out annually and may be carried out with no furnace charge.
...
2.2.3.2.4 A slow strain rate < 0,0003 s<sup>-1</sup> must be used during the entire test, until fracture occurs (This is approximately 10 minutes for the 20 mm diameter specimen). Tensile strength, elongation and reduction of area are to be reported.

2.2.3.2.5 The acceptance requirement for the test is:

Z<sub>1</sub>/Z<sub>2</sub> ≥ 0,85

where:

Z<sub>1</sub> = Reduction of area without baking
Z<sub>2</sub> = Reduction of area after baking

If the requirement Z<sub>1</sub>/Z<sub>2</sub> ≥ 0,85 is not achieved, the bar material may be subjected to a hydrogen degassing treatment after agreement with the Classification Society. New tests shall be performed after degassing.
...
| Grade | Yield stress N/mm<sup>2</sup> minimum <sup>(1)</sup> | Tensile strength N/mm<sup>2</sup> minimum <sup>(1)</sup> | Elongation <sup>(3)</sup> % minimum | Reduction of area % minimum | Charpy V-notch impact tests Test temperature °C <sup>(2)</sup> | Charpy V-notch impact tests Average energy J minimum | Charpy V-notch impact tests Avg. energy flash weld J minimum |
|-------|--------------------|----------------------|-------------|--------------|------------------|-----------------|-----------------------|
| R3    | 410                | 690                  | 17          | 50           | 0<br>-20         | 60<br>40        | 50<br>30              |
| R3S   | 490                | 770                  | 15          | 50           | 0<br>-20         | 65<br>45        | 53<br>33              |
| R4    | 580                | 860                  | 12          | 50           | -20              | 50              | 36                    |
| R4S<sup>(4)</sup> | 700    | 960                  | 12          | 50           | -20              | 56              | 40                    |
| R5<sup>(4)</sup>  | 760    | 1000                 | 12          | 50           | -20              | 58              | 42                    |
...
![Figure 3 - Sampling of steel bars, forgings and castings showing a circular cross section with tensile specimen and specimen for notched bar impact test at r/3 positions, alongside a rolled bar indicating that the 3 CVN test pieces may be taken in series at one location of r/3](assets/ur-w22rev6/part01-fig-003-merged.png)

Alternatively the 3 CVN test pieces may be taken in series at one location of r/3

Figure 3 Sampling of steel bars, forgings and castings
...
| Nominal diameter mm | Tolerance on diameter mm | Tolerance on roundness ( d<sub>max</sub> - d<sub>min</sub>) mm |
|---------------------|--------------------------|-----------------------------------------------------------------|
...
2.3.5.2.4 A slow strain rate < 0,0003 s<sup>-1</sup> must be used during the entire test, until fracture occurs (This is approximately 10 minutes for the 20 mm diameter specimen). Tensile strength, elongation and reduction of area are to be reported.
...
![Figure 4 - Sampling of chain links showing two chain link views with specimen for notched bar impact test at r/3 position and tensile specimen location](assets/ur-w22rev6/part01-fig-005.jpg)

Figure 4 Sampling of chain links
...
|------------------|--------------------|---------------------|--------------------|---------------------|--------------------|
| Proof            | 0.0148 d<sup>2</sup> (44 – 0.08d) | 0.0180 d<sup>2</sup> (44 – 0.08d) | 0.0216 d<sup>2</sup> (44 – 0.08d) | 0.0240 d<sup>2</sup> (44 – 0.08d) | 0.0251 d<sup>2</sup> (44 – 0.08d) |
| Break            | 0.0223 d<sup>2</sup> (44 – 0.08d) | 0.0249 d<sup>2</sup> (44 – 0.08d) | 0.0274 d<sup>2</sup> (44 – 0.08d) | 0.0304 d<sup>2</sup> (44 – 0.08d) | 0.0320 d<sup>2</sup> (44 – 0.08d) |

| Test Load, in kN | Grade R3 Studless | Grade R3S Studless | Grade R4 Studless | Grade R4S Studless | Grade R5 Studless |
|------------------|-------------------|--------------------|-------------------|--------------------|-------------------|
| Proof            | 0.0148 d<sup>2</sup> (44 – 0.08d) | 0.0174 d<sup>2</sup> (44 – 0.08d) | 0.0192 d<sup>2</sup> (44 – 0.08d) | 0.0213 d<sup>2</sup> (44 – 0.08d) | 0.0223 d<sup>2</sup> (44 – 0.08d) |
| Break            | 0.0223 d<sup>2</sup> (44 – 0.08d) | 0.0249 d<sup>2</sup> (44 – 0.08d) | 0.0274 d<sup>2</sup> (44 – 0.08d) | 0.0304 d<sup>2</sup> (44 – 0.08d) | 0.0320 d<sup>2</sup> (44 – 0.08d) |

| Chain Weight, in kg/m | Stud link = 0.0219d<sup>2</sup> |
|-----------------------|---------------------------------|
| Chain Weight, in kg/m | Studless chain<br>Weight calculations for each design are to be submitted. |
...
Note 1:
The cross sectional area at the crown must have no negative tolerance. For diameters of 20 mm or greater, the plus tolerance may be up to 5 percent of the nominal diameter. For diameters less than 20 mm the plus tolerance is to be agreed with the Classification Society at the time of approval.

Note 2:
The cross sectional area at the crown is to be calculated using the average of the diameters with negative tolerance and plus tolerance, measurements are to be taken from at least 2 locations approximately 90 degrees apart.
...
| Designation <sup>(1)</sup> | Description | Nominal Dimension of the Link | Minus Tolerance | Plus Tolerance |
|----------------------------|-------------|-------------------------------|-----------------|----------------|
...
Note 1: Dimension designation is shown in above figure
...
4.4.4 Hardness tests are to be carried out on finished chain. The frequency and locations are to be agreed with the Classification Society. The recorded values are for information only and used as an additional check to verify that the heat treatment process has been stable during chain production.
...
(d) If an accessory is of a large size that will make heat treating in batches unfeasible or has a unique design, strain gauges are to be applied during the proof and break load tests during initial qualification and during production. The strain gauge results from production are to be comparable with results from qualification.
...
The use of separate representative coupons is not permitted as indicated in 5.4.5 below.
...
5.4.5 For individually produced (heat treated) accessories or accessories in small batches, (less than 5), alternative testing can be proposed to the Classification Society. Each proposal for alternative testing is to be detailed by the manufacturer in a written procedure and submitted to the Classification Society, and the following additional conditions may apply:
...
A.4.5 The chain lengths shall be proof load tested in accordance with W22.4.2. The test load for Grade R4 is 4731kN.

Note 1:
Documented evidence of satisfactory testing of similar diameter mooring chain in the prior 6 month period may be used in lieu of break testing subject to agreement with the Classification Society.

Note 2:
The requirements herein are also applicable to other diameter chafing chains, such as 84 mm and 96 mm, subject to compliance with the proof and break load requirements specified for the chain grade and diameters in Section 3 Section 3 Table 5.
