...
# No.3 Transparency of Classification and Statutory Information
...
The actual types of information are as follows:
...
The Table 1 indicates release of information and is applicable to all types of ships with the exception of Tankers and Bulk Carriers subject to SOLAS Chapter II-1 Part A-1 Regulation 3-10 (Goal-based ship construction standards for bulk carriers and oil tankers).

The Table 2 indicates release of information and is applicable to Tankers and Bulk Carriers subject to SOLAS Chapter II-1 Part A-1 Regulation 3-10 (Goal-based ship construction standards for bulk carriers and oil tankers).
...
|  | Information in Question | Owners | Flag State | Port State | Insurance Company* | Ship Yards |
|---|---|---|---|---|---|---|
