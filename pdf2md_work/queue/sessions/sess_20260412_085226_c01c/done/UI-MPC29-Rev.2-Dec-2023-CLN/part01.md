...
For application of these regulations it shall be interpreted as applicable to all ships of 400 gross tonnage or above and, at the Administration's discretion, for ships of less than 400 gross tonnage.

The Bunker Delivery Note (BDN) required by regulation 18.5 is acceptable in either hard copy or electronic format provided it contains at least the information specified in appendix V to MARPOL Annex VI and is retained and made available on board in accordance with regulation 18.6. In addition, an electronic BDN shall be protected from edits, modifications or revisions and authentication be possible by a verification method such as a tracking number, watermark, date and time stamp, QR code, GPS coordinates or other verification methods.
...
3. Rev.2 of the UI is to be uniformly implemented by IACS Societies from 1 July 2024.
