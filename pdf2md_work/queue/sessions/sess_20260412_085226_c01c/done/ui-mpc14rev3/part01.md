...
*Application /Surveys and Inspections*
...
It shall be interpreted that all marine diesel engines over 130 kW except those exempted by Regulation 3 or Regulation 13 are to comply with the Regulation 13 regardless of the gross tonnage of the ship onto which the engine is installed. In this context such engines must have an approved Technical File and must be issued with an EIAPP certificate in accordance with the NO<sub>x</sub> Technical Code in all cases.

However the application of the ship surveys as given in Regulation 5.2 to ships under 400 GT would be at the discretion of the relevant Administration.
...
3. Rev.2 of the UI is to be uniformly implemented by IACS Societies from 1 January 2020.

4. Rev.3 of the UI is to be uniformly implemented by IACS Societies from 1 January 2023.
