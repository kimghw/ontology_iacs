...
![연료유 탱크 밸브 배치를 보여주는 단면도(Section)와 상세도(Detail): Pipe Trunk, F.O.T.(Fuel Oil Tank), Valve, F.O. Line, Air escape pipe or overflow pipe의 위치 관계와 거리 h, w, h/2를 Case 1, Case 2, Case 3로 표시](../../assets/ui-mpc87/part01-fig-000.png)
