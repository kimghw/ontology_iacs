...
(NO<sub>x</sub> Technical Code 2008, Chapter 2, Paragraph 2.4.1.7)

**Paragraph 2.4.1.7, Chapter 2 of the NO<sub>x</sub> Technical Code (NTC) 2008 reads:**
...
(a) It is considered that in this context "specification" shall be read as identification marking and as such the identification of a NOx influencing component by a manufacturer's part number or specific marking scheme would be sufficient
...
(b) The "specification" need only address those aspects of the design of the component which directly affect its function as a NOx critical component. For some components it shall be possible to define these components by means of an outline dimensioned drawing within the conformity of production procedures or as a drawing directly included within the Technical File.
