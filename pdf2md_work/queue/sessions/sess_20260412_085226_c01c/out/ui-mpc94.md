...
6 For ships, other than self-elevating drilling units, having an aggregate oil fuel capacity of 600m<sup>3</sup> and above, oil fuel tanks shall be located above the moulded line of the bottom shell plating nowhere less than the distance h as specified below:
...
![Figure 1 – Oil fuel tank boundary lines for the purpose of paragraph 6: cross-section showing bilge curves rising from the base line with distance h measured from the moulded line of the bottom shell plating](assets/ui-mpc94/part01-fig-000.png)
...
The minimum value of w = 1.0 m, however for individual tanks with an oil fuel capacity of less than 500 m<sup>3</sup> the minimum value is 0.76 m.
...
![Figure 2 – Oil fuel tank boundary lines for the purpose of paragraphs 7 and 8: two cross-sections comparing cases where h is greater than or equal to w and where h is less than w, showing distances w, h and 1.5h relative to the base line](assets/ui-mpc94/part01-fig-001.png)
...
![Figure B – Cross-section of a vessel with deadrising bottom showing distances h and 1.5h measured from the flat bottom and the moulded line of the bottom shell plating, with w marked on the side shell](assets/ui-mpc94/part01-fig-002.png)
