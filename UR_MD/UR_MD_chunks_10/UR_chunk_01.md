...
The net minimum scantlings of the supporting hull structure are to comply with the requirements given in A2.1.5 and A2.2.5. The net thicknesses, $t_{net}$, are the member thicknesses necessary to obtain the above required minimum net scantlings. The required gross thicknesses are obtained by adding the corrosion addition, $t_c$, given in A2.4, to $t_{net}$. Shipboard fittings are to comply with the requirements given in A2.1.4 and A2.2.4. For shipboard fittings not selected from an accepted industry standard the corrosion addition, $t_c$, and the wear allowance, $t_w$, given in A2.4 and A2.5, respectively, are to be considered.
...
*   **Ship Design Minimum Breaking Load ($MBL_{SD}$)** means the minimum breaking load of new, dry mooring lines or tow line for which shipboard fittings and supporting hull structures are designed in order to meet mooring restraint requirements or the towing requirements of other towing service.
...
![Figure 1: Diagram showing the resultant design load on a fitting when a towing line takes a turn.](resultant_load_diagram)
...
![Figure 2: Sample arrangement of reinforcing members beneath shipboard fittings and acting point of towing force.](supporting_structure_diagram)
...
![Figure 3: Diagram showing the attachment point for towing line on a bollard, taken at 4/5 of the tube height.](bollard_attachment_point)
...
*   Normal stress: $1.0\ R_{eH}$
*   Shearing stress: $0.6\ R_{eH}$
...
$R_{eH}$ is the specified minimum yield stress of the material.
...
![Figure 4: Diagrams showing attachment points for mooring lines on bollards: a) at 4/5 height, b) at the location of fins.](mooring_attachment_points)
...
2) Information provided on the plan is to include in respect of each shipboard fitting:
    ...
    2. the ship design minimum breaking load ($MBL_{SD}$);
    3. the acceptable environmental conditions (refer for minimum conditions to IACS Recommendation No. 10 "Anchoring, Mooring and Towing Equipment" for the recommended ship design minimum breaking load for ships with Equipment Number EN > 2000:
        *   30 second mean wind speed from any direction ($v_W$ or $v_W^*$ according to IACS Recommendation No. 10).
        *   Maximum current speed acting on bow or stern ($\pm 10^\circ$)).
...
The total corrosion addition, $t_c$, is not to be less than the following values:

1) Ships covered by Common Structural Rules for Bulk Carriers and Oil Tankers: $t_c$, total corrosion addition to be as defined in these rules.
2) Other ships:
...
In addition to the corrosion addition given in A2.4 the wear allowance, $t_w$, for shipboard fittings not selected from an accepted industry standard is not to be less than 1.0 mm, added to surfaces which are intended to regularly contact the line.
...
4.  Rev.1 of this UR is to be uniformly implemented by IACS Societies:
    i) when an application for certification of an anchor windlass is dated on or after 1st July 2020; or
    ii) to anchor windlasses installed in new ships for which the date of contract for construction is on or after 1st July 2020.
...
### 2.1 Materials
Materials used in the construction of torque-transmitting and load-bearing parts of windlasses are to comply with Rules of the class society or of a national or international material standard. The proposed materials are to be indicated in the construction plans and are to be approved in connection with the design. All such materials are to be certified by the material manufacturers and are to be traceable to the manufacturers' certificates.
...
The windlass prime mover is to be able to exert for at least 30 minutes a continuous duty pull (e.g., 30-minute short time rating corresponding to S2-30 min. of IEC 60034-1), $Z_{cont1}$, corresponding to the grade and diameter, $d$, of the chain cables as follows:

| Grade of chain | $Z_{cont1}$ (N) | $Z_{cont1}$ (kgf) |
| :--- | :--- | :--- |
| 1 | $37.5d^2$ | $3.82d^2$ |
| 2 | $42.5d^2$ | $4.33d^2$ |
| 3 | $47.5d^2$ | $4.84d^2$ |
...
For anchorage depth deeper than 82.5 m, a continuous duty pull $Z_{cont2}$ is:
...
where $D$ is the anchor depth, in metres.

The anchor masses are assumed to be the masses as given in UR A1 and Recommendation 10. Also, the value of $Z_{cont}$ is based on the hoisting of one anchor at a time, and that the effects of buoyancy and hawse pipe efficiency (assumed to be 70%) have been accounted for. In general, stresses in each torque-transmitting component are not to exceed 40% of yield strength (or 0.2% proof stress) of the material under these loading conditions.

#### 3.1.3 Overload Capability
The windlass prime mover is to be able to provide the necessary temporary overload capacity for breaking out the anchor. This temporary overload capacity or "short term pull" is to be at least 1.5 times the continuous duty pull applied for at least 2 minutes. The speed in this period may be lower than normal.
...
The capacity of the windlass brake is to be sufficient to stop the anchor and chain cable when paying out the chain cable. Where a chain cable stopper is not fitted, the brake is to produce a torque capable of withstanding a pull equal to 80% of the specified minimum breaking strength of the chain cable without any permanent deformation of strength members and without brake slip. Where a chain cable stopper is fitted, 45% of the breaking strength may instead be applied.
...
## C6.7 Annual and Special Survey
...
Portable container securing fittings are used to secure containers and are not categorised as fixed container securing fittings.
...
- The type of fixed container securing fittings such as container foundations and lashing eye plates
...
================================================================================
# FILE: UR_D/UR-D8-Rev.3-Feb-2021CLN.md
================================================================================
...
Fire detectors are to be fitted in normally unattended machinery spaces. Detection systems using only thermal detectors, in general, are not to be permitted.
...
================================================================================
# FILE: UR_D/ur-d1rev4.md
================================================================================

# D1 Requirement concerning offshore drilling units and other similar units
...
#### D1.1.6 Requirements for position keeping systems and components
...
#### D1.4.1
The Requirements are intended for units to be constructed of materials manufactured and tested in accordance with the Rules. Where it is intended to use materials manufactured by different processes or having different properties, their use will be specially considered by the Society.
...
#### D1.5.1
Welding is to comply with the Rules. The Society is to be satisfied that all welders to be employed in the construction of units to be classed are properly qualified in the type of work proposed and in the proper use of the welding processes and procedures to be followed. The methods and locations for non-destructive testing of welds are to be submitted to the Society.
...
#### D1.6.1
Upon completion of work, compartments, decks, bulkheads, etc., are to be tested, as specified by the Society.
...
(a) Ship type drilling units are seagoing ship-shaped units having a displacement-type hull or hulls, of the single, catamaran or trimaran types, which have been designed or converted for drilling operations in the floating condition. Such types have propulsion machinery.
...
**D2.7** **Weathertight** means that in any sea conditions water will not penetrate into the unit.

## D2.8 Watertight

**D2.8** **Watertight** means that capability of preventing the passage of water through structure in any direction under the head of water for which the surrounding structure is designed.

## D2.9 Downflooding

**D2.9** **Downflooding** means any flooding of the interior or any part of the buoyant structure of a unit through openings which cannot be closed weathertight, watertight or which are required for operations reasons to be left open in all weather conditions, as appropriate for the intact and damage stability criteria.
...
(a) Design wave criteria specified by the owner (designer) may be described either by means of design wave energy spectra or deterministic design waves having appropriate shape, size and period.
(b) The forces produced by the action of waves on the unit are to be taken into account in the structural design.
(c) Consideration is to be given to the possibility of wave induced vibration.

### D3.3.4 Current loadings

Consideration should be given to the possible superposition of current and waves.
...
Design loadings are not to be less than:

(i) Crew spaces: 4,5 kN/m²
(ii) Work areas: 9 kN/m²
(iii) Storage areas: 13 kN/m²
(iv) Helicopter platform: 2 kN/m²

End of Document


================================================================================
# FILE: UR_D/ur-d4rev3.md
================================================================================
...
(a) Leg types: Legs may be either shell type or truss type.
(b) Legs without mats: Where footings or mats are not fitted, proper consideration should be given to the leg penetration of the sea bed.
(c) Legs in the field transit condition: Legs are to be designed for a bending moment caused by a 6° single amplitude of roll or pitch at the natural period of the unit.
(d) Legs in the ocean transit condition: Legs should be designed for acceleration and gravity moments resulting from the motions in the most severe anticipated environmental transit conditions.
(e) Unit in the elevated position: When computing leg stresses, the maximum overturning load on the unit is to be considered.
(f) Leg scantlings: Leg scantlings are to be determined in accordance with a method of rational analysis.

### D4.3.4 Wave clearance

The unit is to be designed for a crest clearance of either 1,2 m (4 ft), or 10% of the combined storm tide, astronomical tide and height of the maximum wave crest above the mean low water level, whichever is less.

## D4.4 Damage stability

D4.4.1 In assessing the damage stability:
...
D5.2.1 The scantlings of the upper structure are not to be less than those required by the Rules.

### D5.3 Columns, lower hulls and footings

D5.3.1 Main stability columns, lower hulls or footings may be designed as either framed or unframed shells.

### D5.4 Wave clearance

D5.4.1 Unless deck structures are designed for wave impact, reasonable clearance between the deck structures and the wave crests is to be ensured.

### D5.5 Structural Redundancy

D5.5.1 The unit's structure shall be able to withstand the loss of any slender bracing member without causing overall collapse.

### D5.6 Damage Stability

D5.6.1 Damage assumptions for column stabilized drilling units as required by D3.7.3.

End of Document


================================================================================
# FILE: UR_D/ur-d6rev1.md
================================================================================
...
D6.2.1 Scantlings of the hull structure are to meet the Rules.

## D6.3 Barge type drilling units

D6.3.1 Scantlings of the hull structure are to meet the Rules.
...
D7.1.1 All units are to be provided with watertight bulkheads as may be required by the Rules.

## D7.2 Tank boundaries

D7.2.1 Tanks for fresh water or fuel oil are to have divisions or deep swashes as may be required.

## D7.3 Boundary penetrations

D7.3.1 Where watertight boundaries are required for damage stability, they are to be made watertight throughout.

## D7.4 Closures

### D7.4.1 General

External closing appliances are to be as prescribed by applicable load line requirements.

### D7.4.2 General requirements related to watertight integrity

External openings which are used during operation of the unit while afloat, are not to submerge when the unit is inclined to the first intercept of the righting moment and wind heeling moment curves.

### D7.4.3 General requirements related to weathertight integrity

Any opening having its lower edge submerged below a waterline associated with the stability zones is to be fitted with a weathertight closing appliance.

End of Document


================================================================================
# FILE: UR_E/UR-E10-Rev.10-Aug-2024-CLN.md
================================================================================
...
================================================================================
# FILE: UR_E/UR-E18-Rev.2-Jun-2025-CLN.md
================================================================================
...
3. Where vented type batteries and/or valve-regulated sealed type batteries are installed, it is to be ensured that there is adequate ventilation. For vented type batteries, the Society's requirements relevant to the location and installation are complied with.
...
2. A vented type battery is one in which the cells have a cover provided with an opening through which products of electrolysis and evaporation are allowed to escape freely from the cells to atmosphere.

3. A valve-regulated sealed type battery is one in which cells are closed but have an arrangement (valve) which allows the escape of gas if the internal pressure exceeds a predetermined value.

4. The ventilation arrangements for installation of batteries which have charging power higher than 2kW are to be such that the quantity of air expelled is at least equal to:
    ...
    1) **Vented type batteries**
       ...
       $I$ = maximum current delivered by the charging equipment during gas formation
       $Q$ = quantity of air expelled in litres/hr.

    2) **Valve-regulated sealed type batteries**
       The ventilation rate may be reduced to 25 per cent of that given above.
...
.1 when providing an alternative power supply as an accumulator battery for the emergency services defined in SOLAS II-1/42.2.3 or SOLAS II-1/43.2.4,
...
Combination of converters, switches and energy storage devices (such as batteries), constituting a power system for maintaining continuity of load power in case of AC input power failure.

**Double Conversion topology**
A UPS topology comprises an AC to DC converter and a DC to AC converter.

![Figure 1: Double Conversion topology diagram](double_conversion_topology)

**Line interactive topology**
A UPS topology comprises bidirectional AC to DC power conversion.

![Figure 2: Line interactive topology diagram](line_interactive_topology)

**Standby topology**
A UPS topology comprises a battery charger, a DC to AC converter, and a UPS switch.

![Figure 3: Standby topology diagram](standby_topology)

## 3. Design and construction

3.1 UPS units are to be constructed in accordance with IEC 62040-1:2017+AMD1:2021+AMD2:2022, IEC 62040-2:2016, IEC 62040-3:2021, IEC 62040-4:2013 and/or IEC 62040-5-3:2016, as applicable.

3.2 The operation of the UPS is not to depend upon external services.

3.5 The UPS unit is to be monitored and audible and visual alarm is to be given in continuously manned station(s).

## 4. Location

4.1 The UPS unit for emergency services is to be suitably located for use in an emergency.
...
6.1 UPS units of 50 kVA and over are to be surveyed by the Society during manufacturing and testing.

End of Document


================================================================================
# FILE: UR_E/UR-E25-Rev.2-Mar-2022CLN.md
================================================================================
...
(c) Loop failures in closed loop systems, both command and feedback loops
...
3.1 The failures likely to cause uncontrolled movements of rudder are to be clearly identified. In the event of detection of such failure, the rudder is to stop in the current position without manual intervention or, subject to the discretion of the Classification Society, is to return to the midship/neutral position.

End of Document


================================================================================
# FILE: UR_E/UR-E26-Rev.1-Nov-2023-CR.md
================================================================================
...
**Table: Summary of Actions and Documents**
...
| :--- | :--- |
| *CBS security capabilities* | Provide documentation of product security updates: E27 (5.2)<br>Provide documentation of dependent component security updates: E27 (5.3)<br>Provide security updates: E27 (5.4) |
| *CBS documentation* | CBS asset inventory: E27 (3.1.1)<br>Management of change plan: E27 (3.1.9) |
| *Vessel design documentation* | Vessel asset inventory: E26 (4.1.1.4.1) |
| *Ship cyber security and resilience program* | Management of change: E26 (4.1.1.4.4)<br>Management of software updates: E26 (4.1.1.4.4) |
...
| *Vessel design documentation* | Zones and conduit diagram: E26 (4.2.1.4.1)<br>Design description: E26 (4.2.1.4.1)<br>Ship cyber resilience test procedure: E26 (4.2.1.4.3) |
...
| Requirement | Document Reference |
| :--- | :--- |
| *CBS security capabilities* | Denial of service (DoS) protection (item 24): E27 (4.1)<br>Deterministic output (item 20): E27 (4.1) |
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4) |
...
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4) |
| *Vessel design documentation* | Design description: E26 (4.2.3.4.1)<br>Ship cyber resilience test procedure: E26 (4.2.3.4.3) |
...
| Requirement | Document Reference |
| :--- | :--- |
| *CBS security capabilities* | Human user id. and auth. (#1): E27 (4.1)<br>Account management (#2): E27 (4.1)<br>Identifier management (#3): E27 (4.1)<br>Authenticator management (#4): E27 (4.1)<br>Authorisation enforcement (#8): E27 (4.1) |
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4) |
| *Vessel design documentation* | Design description: E26 (4.2.4.4.1)<br>Ship cyber resilience test procedure: E26 (4.2.4.4.3) |
| *Ship cyber security and resilience program* | Management of confidential information: E26 (4.2.4.4.4)<br>Management of logical and physical access: E26 (4.2.4.4.4) |

**Wireless communication (section 4.2.5)**

| Requirement | Document Reference |
| :--- | :--- |
| *CBS security capabilities* | Wireless access management (#5): E27 (4.1)<br>Wireless use control (#9): E27 (4.1) |
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4) |
| *Vessel design documentation* | Design description: E26 (4.2.5.4.1)<br>Ship cyber resilience test procedure: E26 (4.2.5.4.3) |
| *Ship cyber security and resilience program* | |
...
| Requirement | Document Reference |
| :--- | :--- |
| *CBS security capabilities* | Multifactor authentication (#31): E27 (4.2)<br>Process / device id. and auth. (#32): E27 (4.2)<br>Unsuccessful login attempts (#33): E27 (4.2)<br>System use notification (#34): E27 (4.2)<br>Access via untrusted networks (#35): E27 (4.2)<br>Explicit access request approval (#36): E27 (4.2)<br>Remote session termination (#37): E27 (4.2)<br>Cryptographic integrity protection (#38): E27 (4.2)<br>Input validation (#39): E27 (4.2)<br>Session integrity (#40): E27 (4.2)<br>Invalidation of session ID (#41): E27 (4.2) |
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4) |
| *Vessel design documentation* | Design description: E26 (4.2.6.4.1)<br>Ship cyber resilience test procedure: E26 (4.2.6.4.3) |
...
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4) |
| *Vessel design documentation* | Design description: E26 (4.2.7.4.1)<br>Ship cyber resilience test procedure: E26 (4.2.7.4.3) |
...
| Requirement | Document Reference |
| :--- | :--- |
| *CBS security capabilities* | Use control for portable devices (#10): E27 (4.1)<br>Auditable events (#13): E27 (4.1)<br>Denial of service (DoS) protection (#24): E27 (4.1) |
| *CBS documentation* | Alarm excessive bandwidth use: E22 (7.2.1)<br>Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4) |
...
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4)<br>Plans for maintenance and verification: E27 (3.1.7) |
...
| :--- | :--- |
| *CBS security capabilities* | |
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4)<br>Information supporting incident response and recovery plans: E27 (3.1.8) |
| *Vessel design documentation* | Design description: E26 (4.4.1.4.1)<br>Ship cyber resilience test procedure: E26 (4.4.1.4.3) |
...
| *CBS security capabilities* | |
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4)<br>Information supporting incident response and recovery plans: E27 (3.1.8) |
| *Vessel design documentation* | Design description: E26 (4.4.2.4.1)<br>Ship cyber resilience test procedure: E26 (4.4.2.4.3) |
| *Ship cyber security and resilience program* | Incident response plans: E26 (4.4.1.4.4) |
...
| *CBS security capabilities* | |
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4)<br>Information supporting incident response and recovery plans: E27 (3.1.8) |
| *Vessel design documentation* | Design description: E26 (4.4.3.4.1)<br>Ship cyber resilience test procedure: E26 (4.4.3.4.3) |
| *Ship cyber security and resilience program* | Incident response plans: E26 (4.4.1.4.4) |
...
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4)<br>Information supporting incident response and recovery plans: E27 (3.1.8) |
| *Vessel design documentation* | Design description: E26 (4.4.4.4.1)<br>Ship cyber resilience test procedure: E26 (4.4.4.4.3) |
| *Ship cyber security and resilience program* | Incident response plans: E26 (4.4.1.4.4) |
...
| *CBS security capabilities* | |
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4)<br>Information supporting incident response and recovery plans: E27 (3.1.8) |
| *Vessel design documentation* | Design description: E26 (4.5.1.4.1)<br>Ship cyber resilience test procedure: E26 (4.5.1.4.3) |
...
| Requirement | Document Reference |
| :--- | :--- |
| *CBS security capabilities* | System backup (#26): E27 (4.1)<br>System recovery and reconstitution (#27): E27 (4.1) |
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4)<br>Information supporting incident response and recovery plans: E27 (3.1.8) |
...
| *CBS documentation* | Description of security capabilities: E27 (3.1.3)<br>Test procedure for security capabilities: E27 (3.1.4)<br>Information supporting incident response and recovery plans: E27 (3.1.8) |
| *Vessel design documentation* | Design description: E26 (4.5.3.4.1)<br>Ship cyber resilience test procedure: E26 (4.5.3.4.3) |
| *Ship cyber security and resilience program* | Recovery plans: E26 (4.5.1.4.4) |
