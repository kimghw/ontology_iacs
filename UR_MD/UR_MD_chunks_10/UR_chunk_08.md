...
![Figure 1: Maximum water level in a tank](images/ur-z101rev25_p20_full.png)
...
![Technical Assessment and the Survey Planning Process](images/ur-z101rev25_p50_full.png)
...
![Typical Damage and Repair Example](images/ur-z101rev25_p50_img2.png)
...
![Figure 1: Typical transverse section of an oil tanker showing longitudinal and transverse members with numbered labels](images/ur-z101rev25_p69_full.png)
...
![Figure 2: Typical transverse section of an oil/ore ship showing longitudinal and transverse members with numbered labels](images/ur-z101rev25_p70_full.png)
...
![Figure 3: A blank transverse section outline for custom mapping of structural members](images/ur-z101rev25_p71_full.png)
...
![Figure 4: Diagram showing longitudinal member locations for an Oil Tanker](images/ur-z101rev25_p72_full.png)
**Oil Tanker**

![Figure 5: Diagram showing longitudinal member locations for an Ore/oil Ship](images/ur-z101rev25_p72_img6.png)
**Ore/oil Ship**
...
| :--- | :--- |
| ![Figure 6: Oil Tanker Typical transverse section close-up survey](images/ur-z101rev25_p73_full.png) | ![Figure 7: Oil Tanker Typical transverse bulkhead](images/ur-z101rev25_p73_img7.png) |
...
| :--- | :--- |
| ![Figure 8: Oil/Ore ship Typical transverse section close-up survey](images/ur-z101rev25_p73_rendered.png) | ![Figure 9: Oil/Ore ship Typical transverse bulkhead](images/ur-z101rev25_p73_full.png) |
| Typical transverse section close-up survey | Typical transverse bulkhead |
| Thickness to be reported on TM3-T and TM4-T as appropriate | Thickness to be reported on TM5-T |

| Legend | Description |
| :--- | :--- |
| ![Legend Box](images/ur-z101rev25_p73_full.png) | Close-up survey area |
...
![Figure 1: Pitting intensity diagrams](images/ur-z102rev37_p41_full.png)

![Figure 2: Edge corrosion](images/ur-z102rev37_p41_img9.png)

![Figure 3: Grooving corrosion](images/ur-z102rev37_p40_full.png)
...
![Figure 4 - Transverse section of a single skin bulk carrier](images/ur-z102rev37_p40_img8.jpeg)
...
![Figure 5 - Locations of measurements on hatch covers and coamings](images/ur-z102rev37_p41_full.png)
...
![Figure 6 - Locations of measurements on structural members in cargo holds and ballast tanks of single side skin bulk carriers](images/ur-z102rev37_p41_full.png)
...
![Figure 7 - Locations of measurements on cargo hold transverse bulkheads](images/ur-z102rev37_p41_full.png)
...
![Figure 8 - Locations of measurements on transverse bulkheads of topside, hopper and double bottom tanks](images/ur-z102rev37_p41_full.png)
...
![Figure 9 - Locations of measurements on underdeck structure](images/ur-z102rev37_p41_full.png)
...
![Figure 1: Technical Assessment & the Survey Planning Process](images/ur-z102rev37_p81_rendered.png)

***

![Figure 2: Typical Locations Susceptible to Structural Damage or Corrosion](images/ur-z102rev37_p70_full.png)

***

![Figure 3: Typical Damage and Repair Example (Reproduced from Ref: 3)](images/ur-z102rev37_p71_full.png)
...
![Figure: Typical and Non-typical transverse frames in cargo hold showing Upper, Mid, and Lower parts](images/ur-z102rev37_p91_full.png)
...
![Figure: Typical transverse section of a bulk carrier with numbered structural items](images/ur-z102rev37_p95_full.png)
...
![Figure: Generic transverse section outline for custom marking](images/ur-z102rev37_p96_full.png)
...
![Figure: Close-up survey areas on typical transverse section](images/ur-z102rev37_p96_img17.png)
*Thickness to be reported on TM3-BC, TM4-BC, TM6-BC and TM7-BC as appropriate*

### A cargo hold, transverse bulkhead
- **Area C**

![Figure: Close-up survey areas on transverse bulkhead](images/ur-z102rev37_p96_img18.png)
*Thickness to be reported on TM5-BC*

### Typical areas of deck plating inside line of hatch openings between cargo hold hatches
- **Area E**

![Figure: Close-up survey areas on deck plating between hatches](images/ur-z102rev37_p95_img15.png)
...
![Figure 1: Typical transverse frames in cargo hold and Non-typical transverse frame in cargo hold showing gauging areas (A)](images/ur-z102rev37_p117_full.png)
...
![Figure 2: Typical transverse section of a bulk carrier with numbered structural items 1 to 34](images/ur-z102rev37_p118_full.png)
...
![Figure 3: Blank transverse section outline for bulk carriers](images/ur-z102rev37_p119_full.png)
...
**Typical transverse section**
**Areas A, B and D**
![Figure 4: Diagram of Typical transverse section showing Areas A, B and D](images/ur-z102rev37_p119_img21.png)
*Thickness to be reported on TM3-BC(CSR), TM4-BC(CSR), TM6-BC(CSR) and TM7-BC(CSR) as appropriate*

**A cargo hold, transverse bulkhead**
**Area C**
![Figure 5: Diagram of Cargo hold transverse bulkhead showing Area C and components (Upper stool, Topside tank, Lower stool, Double bottom tank, Hopper side tank)](images/ur-z102rev37_p119_img22.png)
*Thickness to be reported on TM5-BC(CSR)*

**Typical areas of deck plating inside line of hatch openings between cargo hold hatches**
**Area E**
![Figure 6: Diagram of deck plating between hatches showing Area E](images/ur-z102rev37_p119_img23.png)
...
![Figure 1: Diagram showing level a and level c gauging locations on a transverse section](images/ur-z102rev37_p121_full.png)

**Figure 1**

![Figure 2: Diagram showing level b and level c gauging locations on a transverse section](images/ur-z102rev37_p121_img24.png)
...
![Figure 1: Zones of Side Shell Frames and Brackets showing Zones A, B, C, and D on a typical side frame](images/ur-z102rev37_p124_full.png)
...
![Figure 2: Pitting intensity diagrams showing 5%, 10%, 15%, 20%, and 25% scattered pitting](images/ur-z102rev37_p125_full.png)
...
![Figure 3: Typical 5 point pattern on the web plate showing gauging points and dimensions](images/ur-z102rev37_p126_full.png)
...
![Figure 4: Sections a) and b) showing location of measurements for section modulus calculation](images/ur-z102rev37_p127_full.png)
